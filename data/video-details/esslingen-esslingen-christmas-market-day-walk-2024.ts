...
const highlightImageBasePath = "/esslingen-esslingen-christmas-market-day-walk-2024/highlights";
const highlightImageSrc = (filename: string) => `${highlightImageBasePath}/${filename}`;

export const esslingenEsslingenChristmasMarketDayWalk2024Detail: VideoDetailRecord = {
