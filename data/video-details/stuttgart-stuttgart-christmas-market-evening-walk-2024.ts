...
const highlightImageBasePath = "/stuttgart-stuttgart-christmas-market-evening-walk-2024/highlights";
const highlightImageSrc = (filename: string) => `${highlightImageBasePath}/${filename}`;

export const stuttgartStuttgartChristmasMarketEveningWalk2024Detail: VideoDetailRecord = {
