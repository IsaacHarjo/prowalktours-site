...
const highlightImageBasePath = "/cologne-cologne-christmas-market-evening-walk-2024/highlights";
const highlightImageSrc = (filename: string) => `${highlightImageBasePath}/${filename}`;

export const cologneCologneChristmasMarketEveningWalk2024Detail: VideoDetailRecord = {
  ...
  highlights: [
    ...
    { title: "Cologne Cathedral", timeLabel: "52", seconds: 52, imageSrc: highlightImageSrc("cologne-cologne-cathedral.jpg"), alt: "Cologne Cathedral during Cologne, Germany Christmas Market Evening Walk (2023)", caption: "Cologne Cathedral", description: "" },
