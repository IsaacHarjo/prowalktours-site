...
export const parisEiffelTowerDayWalk2020Detail: VideoDetailRecord = {
  ...
  highlights: [
    ...
    { title: "Level 3 (Interior)", timeLabel: "26:48", seconds: 1608, imageSrc: highlightImageSrc("paris-level-3-interior.jpg"), alt: "Eiffel Tower summit interior", caption: "Summit Interior", description: "The enclosed summit level with historical displays and Gustave Eiffel\u2019s office." },
    { title: "Level 3 (Exterior)", timeLabel: "34:31", seconds: 2071, imageSrc: highlightImageSrc("paris-level-3-exterior.jpg"), alt: "Eiffel Tower summit exterior panoramic views", caption: "Summit Exterior", description: "Panoramic views from the open-air summit platform in every direction." },
    ...
    { title: "Ground Level", timeLabel: "52:45", seconds: 3165, imageSrc: highlightImageSrc("paris-ground-level.jpg"), alt: "Back at ground level beneath the Eiffel Tower", caption: "Ground Level", description: "The tour ends back at ground level beneath the tower." },
  ],
};
