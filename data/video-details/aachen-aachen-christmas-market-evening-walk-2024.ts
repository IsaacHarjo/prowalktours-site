...
const highlightImageBasePath = "/aachen-aachen-christmas-market-evening-walk-2024/highlights";
const highlightImageSrc = (filename: string) => `${highlightImageBasePath}/${filename}`;

export const aachenAachenChristmasMarketEveningWalk2024Detail: VideoDetailRecord = {
