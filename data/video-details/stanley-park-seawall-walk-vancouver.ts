...
export const stanleyParkSeawallWalkVancouverDetail: VideoDetailRecord = {
  slug: "stanley-park-seawall-walk-vancouver",
  heroEyebrow: "Canada Walk",
  heroTitle: "Stanley Park Seawall Walking Tour",
  heroSubtitle: "Full Loop — Vancouver, British Columbia",
  heroDescription:
    "A daytime walk around the full Stanley Park Seawall loop in Vancouver. The route follows the waterfront path past the Seaplane Terminal, through Stanley Park past Brockton Point and the Girl in a Wetsuit statue, under the Lions Gate Bridge, along Third Beach and Second Beach, and finishes at English Bay Beach and Sunset Beach.",
  routeMapDescription:
    "This route follows the Stanley Park Seawall from the Seaplane Terminal clockwise around the park, passing Brockton Point, Lions Gate Bridge, Third Beach, Second Beach, and ending at English Bay and Sunset Beach.",
  licensingDescription: [
    "This Stanley Park seawall walk was filmed as a clean, long-form record of Vancouver's most iconic waterfront trail. It covers forests, sculptures, beaches, and mountain views, and is well suited for travel editorial, tourism storytelling, fitness content, and location research.",
  ...
  highlights: [
    ...
    { title: "Girl in a Wetsuit Statue & SS Empress of Japan Figurehead", timeLabel: "45:22", seconds: 2722, imageSrc: "", alt: "Girl in a Wetsuit Statue & SS Empress of Japan Figurehead", caption: "Girl in a Wetsuit Statue & SS Empress of Japan Figurehead", description: "" },
    { title: "The Fox's Den Spray Park", timeLabel: "48:18", seconds: 2898, imageSrc: "", alt: "The Fox's Den Spray Park", caption: "The Fox's Den Spray Park", description: "" },
    { title: "Walking Under Lions Gate Bridge", timeLabel: "1:02:28", seconds: 3748, imageSrc: "", alt: "Walking Under Lions Gate Bridge", caption: "Walking Under Lions Gate Bridge", description: "" },
    { title: "Zeus Beach", timeLabel: "1:11:20", seconds: 4280, imageSrc: "", alt: "Zeus Beach", caption: "Zeus Beach", description: "" },
    { title: "Siwash Rock", timeLabel: "1:17:45", seconds: 4665, imageSrc: "", alt: "Siwash Rock", caption: "Siwash Rock", description: "" },
    { title: "Third Beach", timeLabel: "1:21:26", seconds: 4886, imageSrc: "", alt: "Third Beach", caption: "Third Beach", description: "" },
