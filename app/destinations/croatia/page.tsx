...
const embeddedMapUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1dSa03kDRLpJmrqbG1Z52XOjO7KuhBh4";
...
const destinations = [
  {
    ...
    status: "Coming soon",
    description:
      "Future walking tours, waterfront routes, and destination pages across Split.",
  },
  {
    name: "Rovinj",
    status: "Coming soon",
    description:
      "Future walking tours, harbor routes, and destination pages across Rovinj.",
  },
  {
    name: "Pula",
    status: "Coming soon",
    description:
      "Future walking tours, historic routes, and destination pages across Pula.",
  },
];
      ...
      <section className="border-b border-[#eadfce] bg-white">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
          ...
          <p className="mt-5 max-w-3xl text-[18px] leading-8 text-[#6c5b49]">
            Browse Croatia by destination, then expand into cities, coastal
