...
const fullMapUrl =
  "https://www.google.com/maps/d/edit?mid=1MUO_QR_xuFsrEg3dC7JnlJhdkK3hSGE&usp=sharing";
const embeddedMapUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1MUO_QR_xuFsrEg3dC7JnlJhdkK3hSGE";
...
const destinations = [
  {
    ...
    status: "Coming soon",
    description:
      "Future walking tours, neighborhoods, and destination pages across Amsterdam.",
  },
];
    ...
    <main className="bg-[#fcfaf7] text-[#2f261d]">
      <section className="border-b border-[#eadfce] bg-white">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
          ...
          <p className="mt-5 max-w-3xl text-[18px] leading-8 text-[#6c5b49]">
            Browse the Netherlands by destination, then expand into cities,
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 lg:px-10">
        <MapSection
          ...
          eyebrow="Interactive Netherlands Map"
          heading="Explore the Netherlands on the map"
          description={
            <>
              Browse tours in Amsterdam, with more Netherlands destinations added
            over time.
            </>
          }
          iframeSrc={embeddedMapUrl}
          iframeTitle="Interactive Netherlands map"
          iframeLoading="lazy"
          iframeReferrerPolicy="no-referrer-when-downgrade"
          fullMapButtonHref={fullMapUrl}
          fullMapButtonLabel="Open the full Netherlands map"
        />
