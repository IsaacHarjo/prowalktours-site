...
const fullMapUrl =
  "https://www.google.com/maps/d/edit?mid=1XHRsQknoYh_w_el_vPxPyKVKaRT-ZY8&usp=sharing";
const embeddedMapUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1XHRsQknoYh_w_el_vPxPyKVKaRT-ZY8";
...
const destinations = [
  {
    ...
    status: "Coming soon",
    description:
      "Future walking tours and destination pages across Czechia.",
  },
];
    ...
    <main className="bg-[#fcfaf7] text-[#2f261d]">
      <section className="border-b border-[#eadfce] bg-white">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
          ...
          <p className="mt-5 max-w-3xl text-[18px] leading-8 text-[#6c5b49]">
            Browse Czechia by destination, then expand into cities,
            landmarks, and individual walking tours as this growing collection
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 lg:px-10">
        <MapSection
          ...
          eyebrow="Interactive Czechia Map"
          heading="Explore Czechia on the map"
          description={
            <>
              Browse tours across Czechia, with more destinations added over
            time.
            </>
          }
          iframeSrc={embeddedMapUrl}
          iframeTitle="Interactive Czechia map"
          iframeLoading="lazy"
          iframeReferrerPolicy="no-referrer-when-downgrade"
          fullMapButtonHref={fullMapUrl}
          fullMapButtonLabel="Open the full Czechia map"
        />
