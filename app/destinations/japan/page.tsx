...
const fullMapUrl =
  "https://www.google.com/maps/d/edit?mid=1pS8h16VBoC4_O3WcTzNnW4ttoznl2L0&usp=sharing";
const embeddedMapUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1pS8h16VBoC4_O3WcTzNnW4ttoznl2L0";
...
const destinations = [
  {
    ...
    status: "Coming soon",
    description:
      "Future walking tours, neighborhoods, and destination pages across Tokyo.",
  },
  {
    name: "Kyoto",
    status: "Coming soon",
    description:
      "Future walking tours, historic districts, and destination pages across Kyoto.",
  },
];
    ...
    <main className="bg-[#fcfaf7] text-[#2f261d]">
      <section className="border-b border-[#eadfce] bg-white">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
          ...
          <p className="mt-5 max-w-3xl text-[18px] leading-8 text-[#6c5b49]">
            Browse Japan by destination, then expand into cities,
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 lg:px-10">
        <MapSection
          ...
          heading="Explore Japan on the map"
          description={
            <>
              Browse tours in Tokyo and Kyoto, with more Japan destinations added
            over time.
            </>
          }
          iframeSrc={embeddedMapUrl}
          iframeTitle="Interactive Japan map"
          iframeLoading="lazy"
          iframeReferrerPolicy="no-referrer-when-downgrade"
          fullMapButtonHref={fullMapUrl}
          fullMapButtonLabel="Open the full Japan map"
        />
