...
const fullMapUrl =
  "https://www.google.com/maps/d/edit?mid=1WaJS5t2sr3lKd5YaOacdn2k_FwbZbZY&usp=sharing";
const embeddedMapUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1WaJS5t2sr3lKd5YaOacdn2k_FwbZbZY";

const destinations = [
  {
    name: "Pyramids and Sphinx",
    status: "Coming soon",
    description:
      "Future walking tours and destination pages around the Pyramids and Sphinx.",
  },
  {
    name: "Grand Egyptian Museum",
    status: "Coming soon",
    description:
      "Future walking tours and destination pages around the Grand Egyptian Museum.",
  },
  {
    name: "Khan el Khalili",
    status: "Coming soon",
    description:
      "Future walking tours and destination pages across Khan el Khalili.",
  },
];
    ...
    <main className="bg-[#fcfaf7] text-[#2f261d]">
      <section className="border-b border-[#eadfce] bg-white">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
          ...
          <p className="mt-5 max-w-3xl text-[18px] leading-8 text-[#6c5b49]">
            Browse Egypt by destination, then expand into historic sites,
            museums, and individual walking tours as this growing collection
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 lg:px-10">
        <MapSection
          ...
          eyebrow="Interactive Egypt Map"
          heading="Explore Egypt on the map"
          description={
            <>
              Browse tours of the Pyramids and Sphinx, the Grand Egyptian Museum,
            and Khan el Khalili, with more Egypt destinations added over time.
            </>
          }
          iframeSrc={embeddedMapUrl}
          iframeTitle="Interactive Egypt map"
          iframeLoading="lazy"
          iframeReferrerPolicy="no-referrer-when-downgrade"
          fullMapButtonHref={fullMapUrl}
          fullMapButtonLabel="Open the full Egypt map"
        />
