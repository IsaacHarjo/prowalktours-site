...
const embeddedMapUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1N3lkIYI0ONRTKAM8UPyrmXZun2XsElk";
...
const destinations = [
  {
    ...
    status: "Coming soon",
    description:
      "Future walking tours, neighborhoods, and destination pages across Barcelona.",
  },
];
      ...
      <section className="border-b border-[#eadfce] bg-white">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
          ...
          <p className="mt-5 max-w-3xl text-[18px] leading-8 text-[#6c5b49]">
            Browse Spain by destination, then expand into cities,
