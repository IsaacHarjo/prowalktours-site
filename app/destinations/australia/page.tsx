...
const fullMapUrl =
  "https://www.google.com/maps/d/edit?mid=1oIZTMWjFoeM5HKrP7b8BbCBmXTGrCg0&usp=sharing";
const embeddedMapUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1oIZTMWjFoeM5HKrP7b8BbCBmXTGrCg0";
...
const destinations = [
  {
    ...
    status: "Coming soon",
    description:
      "Future walking tours, neighborhoods, and destination pages across Sydney.",
  },
  {
    name: "Bondi Beach",
    status: "Coming soon",
    description:
      "Future walking tours and destination pages across Bondi Beach.",
  },
  {
    name: "Manly",
    status: "Coming soon",
    description:
      "Future walking tours and destination pages across Manly.",
  },
  {
    name: "Cairns",
    status: "Coming soon",
    description:
      "Future walking tours and destination pages across Cairns.",
  },
];
    ...
    <main className="bg-[#fcfaf7] text-[#2f261d]">
      <section className="border-b border-[#eadfce] bg-white">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
          ...
          <p className="mt-5 max-w-3xl text-[18px] leading-8 text-[#6c5b49]">
            Browse Australia by destination, then expand into cities,
            beaches, and individual walking tours as this growing collection
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 lg:px-10">
        <MapSection
          ...
          eyebrow="Interactive Australia Map"
          heading="Explore Australia on the map"
          description={
            <>
              Browse tours in Sydney, Bondi Beach, Manly, and Cairns, with more
            Australia destinations added over time.
            </>
          }
          iframeSrc={embeddedMapUrl}
          iframeTitle="Interactive Australia map"
          iframeLoading="lazy"
          iframeReferrerPolicy="no-referrer-when-downgrade"
          fullMapButtonHref={fullMapUrl}
          fullMapButtonLabel="Open the full Australia map"
        />
