...
const fullMapUrl =
  "https://www.google.com/maps/d/edit?mid=1heg7838h4XKHawdhJgf4CrsGDcx9YjY&usp=sharing";
const embeddedMapUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1heg7838h4XKHawdhJgf4CrsGDcx9YjY";
...
const destinations = [
  {
    ...
    status: "Coming soon",
    description:
      "Future walking tours, coastal routes, and destination pages across Piran.",
  },
];
    ...
    <main className="bg-[#fcfaf7] text-[#2f261d]">
      <section className="border-b border-[#eadfce] bg-white">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
          ...
          <p className="mt-5 max-w-3xl text-[18px] leading-8 text-[#6c5b49]">
            Browse Slovenia by destination, then expand into cities, coastal
            towns, and individual walking tours as this growing collection
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 lg:px-10">
        <MapSection
          ...
          eyebrow="Interactive Slovenia Map"
          heading="Explore Slovenia on the map"
          description={
            <>
              Browse tours in Piran, with more Slovenia destinations added over
            time.
            </>
          }
          iframeSrc={embeddedMapUrl}
          iframeTitle="Interactive Slovenia map"
          iframeLoading="lazy"
          iframeReferrerPolicy="no-referrer-when-downgrade"
          fullMapButtonHref={fullMapUrl}
          fullMapButtonLabel="Open the full Slovenia map"
        />
