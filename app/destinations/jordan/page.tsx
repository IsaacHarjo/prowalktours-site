...
const fullMapUrl =
  "https://www.google.com/maps/d/edit?mid=1d_QEuLjD-93OEVN-oOJHX3aAVtf6cmM&usp=sharing";
const embeddedMapUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1d_QEuLjD-93OEVN-oOJHX3aAVtf6cmM";
...
const destinations = [
  {
    ...
    status: "Coming soon",
    description:
      "Future walking tours, neighborhoods, and destination pages across Amman.",
  },
  {
    name: "Petra",
    status: "Coming soon",
    description:
      "Future walking tours and destination pages across Petra.",
  },
];
    ...
    <main className="bg-[#fcfaf7] text-[#2f261d]">
      <section className="border-b border-[#eadfce] bg-white">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
          ...
          <p className="mt-5 max-w-3xl text-[18px] leading-8 text-[#6c5b49]">
            Browse Jordan by destination, then expand into cities,
            historic sites, and individual walking tours as this growing
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 lg:px-10">
        <MapSection
          ...
          eyebrow="Interactive Jordan Map"
          heading="Explore Jordan on the map"
          description={
            <>
              Browse tours in Amman and Petra, with more Jordan destinations
            added over time.
            </>
          }
          iframeSrc={embeddedMapUrl}
          iframeTitle="Interactive Jordan map"
          iframeLoading="lazy"
          iframeReferrerPolicy="no-referrer-when-downgrade"
          fullMapButtonHref={fullMapUrl}
          fullMapButtonLabel="Open the full Jordan map"
        />
