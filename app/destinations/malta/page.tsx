...
const fullMapUrl =
  "https://www.google.com/maps/d/edit?mid=1QmHpQjPAXOFxNvnR8I5GSJEixZgzx2s&usp=sharing";
const embeddedMapUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1QmHpQjPAXOFxNvnR8I5GSJEixZgzx2s";
...
const destinations = [
  {
    ...
    status: "Coming soon",
    description:
      "Future walking tours and destination pages across Malta.",
  },
];
    ...
    <main className="bg-[#fcfaf7] text-[#2f261d]">
      <section className="border-b border-[#eadfce] bg-white">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
          ...
          <p className="mt-5 max-w-3xl text-[18px] leading-8 text-[#6c5b49]">
            Browse Malta by destination, then expand into historic areas,
            coastal spots, and individual walking tours as this growing
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 lg:px-10">
        <MapSection
          ...
          eyebrow="Interactive Malta Map"
          heading="Explore Malta on the map"
          description={
            <>
          ...
          iframeTitle="Interactive Malta map"
          iframeLoading="lazy"
          iframeReferrerPolicy="no-referrer-when-downgrade"
          fullMapButtonHref={fullMapUrl}
          fullMapButtonLabel="Open the full Malta map"
        />
