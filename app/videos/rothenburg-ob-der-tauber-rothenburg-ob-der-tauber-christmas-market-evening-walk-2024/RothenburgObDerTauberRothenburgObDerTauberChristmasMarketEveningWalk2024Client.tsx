...
import { rothenburgObDerTauberRothenburgObDerTauberChristmasMarketEveningWalk2024Detail as detail } from "../../../data/video-details/rothenburg-ob-der-tauber-rothenburg-ob-der-tauber-christmas-market-evening-walk-2024";
...
const video = germanyVideos.find((v) => v.slug === "rothenburg-ob-der-tauber-rothenburg-ob-der-tauber-christmas-market-evening-walk-2024");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "rNwRKSRIVgk";
const heroImagePath = "/rothenburg-ob-der-tauber-rothenburg-ob-der-tauber-christmas-market-evening-walk-2024/hero.jpg";
...
export default function RothenburgObDerTauberRothenburgObDerTauberChristmasMarketEveningWalk2024Client() {
