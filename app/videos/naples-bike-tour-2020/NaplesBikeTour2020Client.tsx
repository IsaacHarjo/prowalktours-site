...
export default function NaplesBikeTour2020Client() {
  ...
  const fullMapUrl = "https://www.google.com/maps/d/u/0/edit?mid=14gZm2Mt6vNX-gweGtClbwnvxEM3OWijN&usp=sharing";
  const fullMapEmbedUrl = "https://www.google.com/maps/d/u/0/embed?mid=14gZm2Mt6vNX-gweGtClbwnvxEM3OWijN";
  ...
  const relatedTours = [
    { title: "Naples Day Walk", href: "/videos/naples-daytime-walk-2023", description: "Continue with a long-form Naples walk through the historic center, markets, and waterfront.", imageSrc: "https://i.ytimg.com/vi/990AqbKb18c/maxresdefault.jpg", imageAlt: "Naples daytime walk thumbnail" },
    { title: "Naples Night Walk", href: "/videos/naples-night-walk-2025", description: "See Naples after dark with Via Toledo, the Spanish Quarter, and the waterfront at night.", imageSrc: "https://i.ytimg.com/vi/Cv1zIRhxvHU/maxresdefault.jpg", imageAlt: "Naples night walk thumbnail" },
    { title: "Naples Destination Hub", href: "/destinations/italy/campania/naples", description: "Browse Naples walking tours, future specialty rides, and more city coverage from Campania.", imageSrc: ogImageUrl, imageAlt: "Naples destination page preview" },
  ];
