...
const fullMapUrl =
  "https://www.google.com/maps/d/u/0/edit?mid=14gZm2Mt6vNX-gweGtClbwnvxEM3OWijN&usp=sharing";
const fullMapEmbedUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=14gZm2Mt6vNX-gweGtClbwnvxEM3OWijN";
const fullMapQrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=${encodeURIComponent(fullMapUrl)}`;
const bikeVideo = italyVideos.find(
  (video) => video.slug === "naples-bike-tour-2020"
);
const youtubeUrl = bikeVideo?.youtubeUrl ?? "https://youtu.be/IHXZnU2bmc8";
const youtubeVideoId = youtubeUrl.split("/").pop() ?? "IHXZnU2bmc8";
const ogImageUrl =
  bikeVideo?.thumbnail ?? `https://i.ytimg.com/vi/${youtubeVideoId}/maxresdefault.jpg`;
const metadataTitle = "Naples, Italy Bike Tour - May 2020";
const metadataDescription = bikeVideo?.shortDescription ?? naplesBikeTour2020Detail.heroDescription;
...
const breadcrumbs = [
  ...
  { label: "Naples Bike Tour (May 2020)" },
];

const topRowStats = [
  { icon: "\uD83D\uDCC5", label: "Date", value: "Saturday, May 23, 2020" },
  { icon: "\uD83D\uDCCF", label: "Distance", value: "20 mi / 32.2 km" },
  { icon: "\uD83D\uDD52", label: "Duration", value: bikeVideo?.durationLabel ?? "1h 54m" },
  { icon: "\u2600\uFE0F", label: "Weather", value: bikeVideo?.weather ?? "73 F / 23 C" },
];

const relatedTours = [
  {
    title: "Naples Day Walk",
    href: "/videos/naples-daytime-walk-2023",
    description:
      "Continue with a long-form Naples walk through the historic center, markets, and waterfront.",
    imageSrc: "https://i.ytimg.com/vi/990AqbKb18c/maxresdefault.jpg",
    imageAlt: "Naples daytime walk thumbnail",
  },
  {
    title: "Naples Night Walk",
    href: "/videos/naples-night-walk-2025",
    description:
      "See Naples after dark with Via Toledo, the Spanish Quarter, and the waterfront at night.",
    imageSrc: "https://i.ytimg.com/vi/Cv1zIRhxvHU/maxresdefault.jpg",
    imageAlt: "Naples night walk thumbnail",
  },
  {
    title: "Naples Destination Hub",
    href: "/destinations/italy/campania/naples",
    description:
      "Browse Naples walking tours, future specialty rides, and more city coverage from Campania.",
    imageSrc: ogImageUrl,
    imageAlt: "Naples destination page preview",
  },
];
  ...
  const breadcrumbStructuredData = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 6,
        name: "Naples Bike Tour - May 2020",
        item: pageUrl,
      },
    ],
  };
      ...
      >
            ...
            <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
              ...
              <div className="relative hidden overflow-hidden rounded-[2rem] border border-[#d8c7b5] bg-white shadow-sm lg:block">
                <div className="relative aspect-[4/3] w-full">
                  <img
                    src={ogImageUrl}
                    alt="Naples bike tour video thumbnail"
        ...
        >
          <div>
            ...
            <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">
              Follow the ride through Naples
            </h2>
          </div>

          <div className="mt-8 flex gap-4 overflow-x-auto scroll-smooth pb-2">
            {naplesBikeTour2020Detail.highlights.map((highlight) => (
              <div
        ...
        >
          <MapSection
            ...
            description={naplesBikeTour2020Detail.routeMapDescription}
            iframeSrc={fullMapEmbedUrl}
            iframeTitle="Naples bike route map"
              ...
              <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                <div className="max-w-xl">
                  ...
                  <p className="mt-3 text-[15px] leading-7 text-[#56493a]">
                    Scan to open the Naples bike route on your phone using Google Maps.
                  </p>
                  <a
                    href={fullMapUrl}
                    target="_blank"
                ...
                <a
                  ...
                  aria-label="Open the Naples bike route map on your phone"
                >
                  <img
                    src={fullMapQrUrl}
                    alt="QR code for opening the Naples bike route in Google Maps"
                    width="132"
                    height="132"
          ...
          <div className="rounded-[2rem] border border-[#d8c7b5] bg-[#f7efe4] p-7 shadow-xl lg:p-8">
            <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr]">
              <div>
                ...
                <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">
                  License this Naples bike footage
                </h2>

                <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">
                  {naplesBikeTour2020Detail.licensingDescription[0]}
                </p>

                <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">
                  {naplesBikeTour2020Detail.licensingDescription[1]}
                </p>
              </div>
        ...
        >
          ...
          <p className="mt-4 max-w-3xl text-base leading-8 text-[#56493a]">
            Continue through Naples with more long-form tours and destination pages from Campania.
          </p>
