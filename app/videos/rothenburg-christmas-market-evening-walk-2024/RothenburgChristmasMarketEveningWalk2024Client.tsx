...
import { rothenburgChristmasMarketEveningWalk2024Detail as detail } from "../../../data/video-details/rothenburg-christmas-market-evening-walk-2024";
...
const video = germanyVideos.find((v) => v.slug === "rothenburg-christmas-market-evening-walk-2024");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "rNwRKSRIVgk";
...
export default function RothenburgChristmasMarketEveningWalk2024Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udccf", label: "Distance", value: "2.30 mi / 3.70 km" },
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "2:22:30" },
    { icon: "\ud83c\udf19", label: "Weather", value: "1°C | 34°F" },
  ];
          ...
          <div className="mt-6 rounded-[1.75rem] border border-[#d8c7b5] bg-[#fcfaf6] p-5 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <a href="https://www.google.com/maps/d/viewer?mid=187uVESxX4xfYBW578u06GP5HgpqH0X0" target="_blank" rel="noreferrer" className="mt-4 inline-flex items-center justify-center rounded-full border border-[#167fd5] bg-white px-4 py-2 text-sm font-semibold text-[#167fd5] shadow-sm transition hover:bg-[#edf6fd]">Open the route in Google Maps</a>
              </div>
              <a href="https://www.google.com/maps/d/viewer?mid=187uVESxX4xfYBW578u06GP5HgpqH0X0" target="_blank" rel="noreferrer" className="self-start rounded-[1.5rem] border border-[#e5d7c6] bg-white p-3 shadow-sm transition hover:border-[#cdb7a0]" aria-label="Open route on phone"><img src={`https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=${encodeURIComponent("https://www.google.com/maps/d/viewer?mid=187uVESxX4xfYBW578u06GP5HgpqH0X0")}`} alt="QR code for route" width="132" height="132" className="h-[132px] w-[132px] rounded-xl" /></a>
            </div>
          </div>
        </MapSection>
      </section>
