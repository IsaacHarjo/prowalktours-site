...
const youtubeVideoId = videoRecord?.youtubeUrl.split("/").pop() ?? "faUNhaRLpMc";
const fullMapUrl =
  "https://www.google.com/maps/d/u/0/edit?mid=1WyUj0jE7INvr_u_v_1ZpHZ4ONa6xlD3e&usp=sharing";
const fullMapEmbedUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1WyUj0jE7INvr_u_v_1ZpHZ4ONa6xlD3e";
...
const breadcrumbs = [
  ...
  { label: "Vancouver, Canada Walking Tour" },
];

const detail = vancouverCanadaWalkingTourDetail;
const highlights = detail.highlights;

const relatedVideos: RelatedVideo[] = [
  {
    title: "Stanley Park Seawall Walk",
    href: "/videos/stanley-park-seawall-walk-vancouver",
    description: "Walk the full seawall loop around Stanley Park.",
    thumbnail: "https://i.ytimg.com/vi/uN7UkfKc-_w/maxresdefault.jpg",
  },
  {
    title: "Vancouver Bike Tour (2025)",
    href: "/videos/vancouver-bike-tour-2025",
    description: "A 45-mile bike tour through Vancouver's seawall and downtown.",
...
export default function VancouverCanadaWalkingTourClient() {
  ...
  const topRowStats = [
    ...
    { icon: "📏", label: "Distance", value: "12.5 mi / 20.1 km" },
    ...
    >
      ...
      <section ref={videoSectionRef} className="mx-auto max-w-6xl px-6 pb-6 pt-6 lg:px-10 lg:pb-6 lg:pt-14">
        <div className="overflow-hidden rounded-[2rem] border border-[#d8c7b5] shadow-lg">
          <div className="aspect-video w-full bg-black">
            {mounted && (<iframe ref={playerIframeRef} className="h-full w-full" src={initialYoutubeEmbedUrl} title="Vancouver Canada walking tour" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />)}
          </div>
        </div>
      </section>
      ...
      <section id="route-map" ref={routeMapRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 py-8 lg:px-10 lg:py-10">
        <MapSection
          ...
          iframeTitle="Vancouver walking route map"
          ...
          <div className="mt-6 rounded-[1.75rem] border border-[#d8c7b5] bg-[#fcfaf6] p-5 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-[15px] leading-7 text-[#56493a]">Scan to open the Vancouver walking route on your phone using Google Maps.</p>
              ...
              <a href={fullMapUrl} target="_blank" rel="noreferrer" className="self-start rounded-[1.5rem] border border-[#e5d7c6] bg-white p-3 shadow-sm transition hover:border-[#cdb7a0]" aria-label="Open the Vancouver route map on your phone">
                <img src={fullMapQrUrl} alt="QR code for opening the Vancouver walking route in Google Maps" width="132" height="132" className="h-[132px] w-[132px] rounded-xl" />
              </a>
            </div>
          </div>
        </MapSection>
      ...
      <section id="related-tours" ref={relatedToursRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 pb-16 lg:px-10">
        ...
        <p className="mt-4 max-w-3xl text-base leading-8 text-[#56493a]">Continue exploring Vancouver with more walking and biking tours.</p>
