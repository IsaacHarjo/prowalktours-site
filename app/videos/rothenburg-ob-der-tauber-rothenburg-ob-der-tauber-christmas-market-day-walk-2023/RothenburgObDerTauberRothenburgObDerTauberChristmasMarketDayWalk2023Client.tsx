...
import { rothenburgObDerTauberRothenburgObDerTauberChristmasMarketDayWalk2023Detail as detail } from "../../../data/video-details/rothenburg-ob-der-tauber-rothenburg-ob-der-tauber-christmas-market-day-walk-2023";
...
const video = germanyVideos.find((v) => v.slug === "rothenburg-ob-der-tauber-rothenburg-ob-der-tauber-christmas-market-day-walk-2023");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "EzZhJgqsdYU";
const heroImagePath = "/rothenburg-ob-der-tauber-rothenburg-ob-der-tauber-christmas-market-day-walk-2023/hero.jpg";
...
const relatedTours = [
      { title: "Nuremberg Christmas Market Evening (2024)", href: "/videos/nuremberg-nuremberg-christmas-market-evening-walk-2024", description: "The Christkindlesmarkt and old town of Nuremberg lit up for Christmas.", imageSrc: "https://i.ytimg.com/vi/CRAigMYQ4cM/maxresdefault.jpg", imageAlt: "Nuremberg Christmas market" },
...
export default function RothenburgObDerTauberRothenburgObDerTauberChristmasMarketDayWalk2023Client() {
