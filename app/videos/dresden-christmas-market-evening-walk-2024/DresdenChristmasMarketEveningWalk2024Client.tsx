...
import { dresdenChristmasMarketEveningWalk2024Detail as detail } from "../../../data/video-details/dresden-christmas-market-evening-walk-2024";
...
const video = germanyVideos.find((v) => v.slug === "dresden-christmas-market-evening-walk-2024");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "LWqbdWbnGlk";
const heroImagePath = "/dresden-christmas-market-evening-walk-2024/hero.jpg";
...
export default function DresdenChristmasMarketEveningWalk2024Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "1:34:36" },
