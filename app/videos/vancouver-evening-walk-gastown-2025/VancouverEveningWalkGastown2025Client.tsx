...
const youtubeVideoId = videoRecord?.youtubeUrl.split("/").pop() ?? "idp8quobV8o";
const fullMapUrl =
  "https://www.google.com/maps/d/edit?mid=1QuDe-EgJsQB0vNPzIvbbICSSyYe4dRs&usp=sharing";
const fullMapEmbedUrl =
  "https://www.google.com/maps/d/embed?mid=1QuDe-EgJsQB0vNPzIvbbICSSyYe4dRs";
...
const breadcrumbs = [
  ...
  { label: "Vancouver Evening Walk — Gastown" },
];

const detail = vancouverEveningWalkGastown2025Detail;
...
const relatedVideos: RelatedVideo[] = [
  {
    ...
    description: "A full-day walking tour through Vancouver's neighborhoods.",
  ...
  },
  {
    ...
    description: "Explore Granville Island's public market and waterfront.",
    thumbnail: "https://i.ytimg.com/vi/fyQqc6cZNA8/maxresdefault.jpg",
  },
];

export default function VancouverEveningWalkGastown2025Client() {
  ...
  const topRowStats = [
    ...
    { icon: "📏", label: "Distance", value: "4.6 mi / 7.4 km" },
    { icon: "🕒", label: "Duration", value: videoRecord?.durationLabel ?? "1:46:04" },
    ...
    >
      ...
      <section id="route-map" ref={routeMapRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 py-8 lg:px-10 lg:py-10">
        <MapSection
          ...
          iframeTitle="Vancouver evening walk route map"
          ...
          <div className="mt-6 rounded-[1.75rem] border border-[#d8c7b5] bg-[#fcfaf6] p-5 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-[15px] leading-7 text-[#56493a]">Scan to open the Vancouver evening walking route on your phone using Google Maps.</p>
              ...
              <a href={fullMapUrl} target="_blank" rel="noreferrer" className="self-start rounded-[1.5rem] border border-[#e5d7c6] bg-white p-3 shadow-sm transition hover:border-[#cdb7a0]" aria-label="Open the Vancouver evening route map on your phone">
                <img src={fullMapQrUrl} alt="QR code for opening the Vancouver evening walking route in Google Maps" width="132" height="132" className="h-[132px] w-[132px] rounded-xl" />
              </a>
            </div>
          </div>
        </MapSection>
                ...
                <div className="rounded-[1.25rem] border border-[#eadfce] bg-[#fcfaf6] p-4">
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <span className="mt-1 block text-sm font-semibold text-[#5c4c33]">Rec.709 — April 2025</span>
                    </div>
                  </div>
                </div>
              </div>
