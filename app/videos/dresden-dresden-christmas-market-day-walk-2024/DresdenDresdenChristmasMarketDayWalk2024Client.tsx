...
import { dresdenDresdenChristmasMarketDayWalk2024Detail as detail } from "../../../data/video-details/dresden-dresden-christmas-market-day-walk-2024";
...
const video = germanyVideos.find((v) => v.slug === "dresden-dresden-christmas-market-day-walk-2024");
...
export default function DresdenDresdenChristmasMarketDayWalk2024Client() {
