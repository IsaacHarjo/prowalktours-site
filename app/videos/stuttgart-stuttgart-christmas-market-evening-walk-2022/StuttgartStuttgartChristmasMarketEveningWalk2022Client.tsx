...
import { stuttgartStuttgartChristmasMarketEveningWalk2022Detail as detail } from "../../../data/video-details/stuttgart-stuttgart-christmas-market-evening-walk-2022";
...
const video = germanyVideos.find((v) => v.slug === "stuttgart-stuttgart-christmas-market-evening-walk-2022");
...
export default function StuttgartStuttgartChristmasMarketEveningWalk2022Client() {
