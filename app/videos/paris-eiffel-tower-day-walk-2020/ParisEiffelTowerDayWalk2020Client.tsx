...
const video = franceVideos.find((v) => v.slug === "paris-eiffel-tower-day-walk-2020");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "Lrj8LEZ9FA4";
...
const breadcrumbs = [
  ...
  { label: "Eiffel Tower Tour (2020)" },
];

const highlights = parisEiffelTowerDayWalk2020Detail.highlights;

const relatedTours = [
  { title: "Paris Day Walk (2020)", href: "/videos/paris-landmarks-day-walk-2020", description: "A 12-mile Paris route that also includes a full Eiffel Tower ascent, plus the Panth\u00e9on, Louvre, Champs-\u00c9lys\u00e9es, and Arc de Triomphe.", imageSrc: "https://i.ytimg.com/vi/oz1Mgu8e1N4/maxresdefault.jpg", imageAlt: "Paris landmarks day walk" },
  { title: "Paris Luxembourg Gardens Walk (2020)", href: "/videos/paris-luxemburg-gardens-day-walk-2020", description: "A compact garden walk through the Grand Basin, Statue of Liberty, rose garden, and Palais du Luxembourg.", imageSrc: "https://i.ytimg.com/vi/bibZZXvk-UE/maxresdefault.jpg", imageAlt: "Luxembourg Gardens" },
  { title: "Paris Evening Walk (2022)", href: "/videos/paris-evening-walk-2022", description: "An evening route through central Paris including Eiffel Tower views, Notre-Dame, the Marais, and the Louvre.", imageSrc: "https://i.ytimg.com/vi/fKgP6JGAM_A/maxresdefault.jpg", imageAlt: "Paris evening walk" },
];

export default function ParisEiffelTowerDayWalk2020Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83c\udfe0", label: "Type", value: "Attraction Tour" },
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "52:45" },
  ...
  return (
    ...
    >
        ...
        <div className="mx-auto max-w-6xl px-6 py-12 lg:px-10 lg:py-16">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="min-w-0">
              <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#9a735a]">{parisEiffelTowerDayWalk2020Detail.heroEyebrow}</p>
              <h1 className="mt-3 text-4xl font-bold tracking-tight text-[#3d3327] sm:text-5xl">{parisEiffelTowerDayWalk2020Detail.heroTitle}</h1>
              <p className="mt-3 text-xl text-[#6e5a45]">{parisEiffelTowerDayWalk2020Detail.heroSubtitle}</p>
              <p className="mt-6 max-w-3xl text-base leading-8 text-[#56493a]">{parisEiffelTowerDayWalk2020Detail.heroDescription}</p>
              <div className="mt-8 space-y-4 border-y border-[#d8c7b5]/80 py-4 text-[#3d3327]"><LongFormWalkStatsRow stats={topRowStats} /></div>
            </div>
            <div className="relative hidden overflow-hidden rounded-[2rem] border border-[#d8c7b5] bg-white shadow-sm lg:block"><div className="relative aspect-[4/3] w-full"><img src={heroImagePath} alt="Eiffel Tower tour" className="h-full w-full object-cover" loading="eager" /></div></div>
          </div>
        </div>
      </section>
      ...
      <section ref={videoSectionRef as React.RefObject<HTMLElement>} className="mx-auto max-w-6xl px-6 pb-6 pt-6 lg:px-10 lg:pb-6 lg:pt-14">
        <div className="overflow-hidden rounded-[2rem] border border-[#d8c7b5] shadow-lg"><div className="aspect-video w-full bg-black">{mounted && (<iframe ref={playerIframeRef} className="h-full w-full" src={initialYoutubeEmbedUrl} title="Paris Eiffel Tower Tour (2020)" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />)}</div></div>
      </section>
        ...
        <div className="rounded-[2rem] border border-[#d8c7b5] bg-[#f7efe4] p-7 shadow-xl lg:p-8">
          <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">License this Eiffel Tower footage</h2>
              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">{parisEiffelTowerDayWalk2020Detail.licensingDescription[0]}</p>
              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">{parisEiffelTowerDayWalk2020Detail.licensingDescription[1]}</p>
            </div>
      ...
      <section id="related-tours" ref={relatedToursRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 pb-16 lg:px-10">
        ...
        <p className="mt-4 max-w-3xl text-base leading-8 text-[#56493a]">Continue with a full Paris landmarks route, Luxembourg Gardens, or an evening walk.</p>
