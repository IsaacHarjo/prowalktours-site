...
const video = franceVideos.find((v) => v.slug === "paris-luxemburg-gardens-day-walk-2020");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "bibZZXvk-UE";
const heroImagePath = "/paris-luxemburg-gardens-day-walk-2020/hero.jpg";
const fullMapUrl = "https://www.google.com/maps/d/viewer?mid=17aM1KjVmJnKKh-4IQxmxcH11uMWH06g";
const fullMapEmbedUrl = "https://www.google.com/maps/d/u/0/embed?mid=17aM1KjVmJnKKh-4IQxmxcH11uMWH06g";
...
const breadcrumbs = [
  ...
  { label: "Luxembourg Gardens Walk (2020)" },
];

const highlights = parisLuxemburgGardensDayWalk2020Detail.highlights;

const relatedTours = [
  { title: "Paris Day Walk (2020)", href: "/videos/paris-landmarks-day-walk-2020", description: "A 12-mile daytime route that also passes through Luxembourg Gardens, plus the Panth\u00e9on, Louvre, Champs-\u00c9lys\u00e9es, and the Eiffel Tower.", imageSrc: "https://i.ytimg.com/vi/oz1Mgu8e1N4/maxresdefault.jpg", imageAlt: "Paris landmarks day walk" },
  { title: "Paris Promenade Plant\u00e9e Walk (2020)", href: "/videos/paris-promenade-plantee-day-walk-2020", description: "Another Paris green space walk along the Coul\u00e9e Verte Ren\u00e9-Dumont elevated greenway.", imageSrc: "https://i.ytimg.com/vi/KoORZY4TygU/maxresdefault.jpg", imageAlt: "Paris Promenade Plant\u00e9e" },
...
export default function ParisLuxemburgGardensDayWalk2020Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udccf", label: "Distance", value: "1.3 mi / 2.2 km" },
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "29:09" },
  ...
  return (
    ...
    >
        ...
        <div className="mx-auto max-w-6xl px-6 py-12 lg:px-10 lg:py-16">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="min-w-0">
              <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#9a735a]">{parisLuxemburgGardensDayWalk2020Detail.heroEyebrow}</p>
              <h1 className="mt-3 text-4xl font-bold tracking-tight text-[#3d3327] sm:text-5xl">{parisLuxemburgGardensDayWalk2020Detail.heroTitle}</h1>
              <p className="mt-3 text-xl text-[#6e5a45]">{parisLuxemburgGardensDayWalk2020Detail.heroSubtitle}</p>
              <p className="mt-6 max-w-3xl text-base leading-8 text-[#56493a]">{parisLuxemburgGardensDayWalk2020Detail.heroDescription}</p>
              <div className="mt-8 space-y-4 border-y border-[#d8c7b5]/80 py-4 text-[#3d3327]"><LongFormWalkStatsRow stats={topRowStats} /></div>
            </div>
            <div className="relative hidden overflow-hidden rounded-[2rem] border border-[#d8c7b5] bg-white shadow-sm lg:block"><div className="relative aspect-[4/3] w-full"><img src={heroImagePath} alt="Luxembourg Gardens in Paris" className="h-full w-full object-cover" loading="eager" /></div></div>
          </div>
        </div>
      </section>
      ...
      <section ref={videoSectionRef as React.RefObject<HTMLElement>} className="mx-auto max-w-6xl px-6 pb-6 pt-6 lg:px-10 lg:pb-6 lg:pt-14">
        <div className="overflow-hidden rounded-[2rem] border border-[#d8c7b5] shadow-lg"><div className="aspect-video w-full bg-black">{mounted && (<iframe ref={playerIframeRef} className="h-full w-full" src={initialYoutubeEmbedUrl} title="Paris Luxembourg Gardens Walk (2020)" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />)}</div></div>
      </section>
          ...
          <div className="mt-6 rounded-[1.75rem] border border-[#d8c7b5] bg-[#fcfaf6] p-5 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-[15px] leading-7 text-[#56493a]">Scan to open the Luxembourg Gardens walk route on your phone using Google Maps.</p>
        ...
        <div className="rounded-[2rem] border border-[#d8c7b5] bg-[#f7efe4] p-7 shadow-xl lg:p-8">
          <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">License this Luxembourg Gardens footage</h2>
              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">{parisLuxemburgGardensDayWalk2020Detail.licensingDescription[0]}</p>
              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">{parisLuxemburgGardensDayWalk2020Detail.licensingDescription[1]}</p>
            </div>
      ...
      <section id="related-tours" ref={relatedToursRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 pb-16 lg:px-10">
        ...
        <p className="mt-4 max-w-3xl text-base leading-8 text-[#56493a]">Continue with a full Paris landmarks route, another green space walk, or an evening tour.</p>
