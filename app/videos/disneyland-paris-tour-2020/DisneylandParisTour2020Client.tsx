...
import { disneylandParisTour2020Detail as detail } from "../../../data/video-details/disneyland-paris-tour-2020";
...
const video = franceVideos.find((v) => v.slug === "disneyland-paris-tour-2020");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "ALXKzjfWj8E";
const heroImagePath = "/disneyland-paris-tour-2020/hero.jpg";

const breadcrumbs = [{"label":"Home","href":"/"},{"label":"Countries","href":"/countries"},{"label":"France","href":"/destinations/france"},{"label":"Paris","href":"/destinations/france/paris"},{"label":"Disneyland, Paris 4K Tour"}];
...
export default function DisneylandParisTour2020Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udccf", label: "Distance", value: "7.00 mi / 11.30 km" },
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "3:02:24" },
    { icon: "\u2600\ufe0f", label: "Weather", value: "33°C | 91°F" },
  ];
        ...
        <div className="rounded-[2rem] border border-[#d8c7b5] bg-[#f7efe4] p-7 shadow-xl lg:p-8">
          <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">License this Chessy footage</h2>
            ...
            <div className="rounded-[1.75rem] border border-[#d8c7b5] bg-white p-5 shadow-sm sm:p-6">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-[1.25rem] border border-[#eadfce] bg-[#fcfaf6] p-4"><div className="space-y-3">
                    <div className="border-b border-[#efe3d3] pb-3"><p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#9a735a]">Camera</p><span className="mt-1 block text-sm font-semibold text-[#5c4c33]">GoPro Hero 8</span></div>
                    <div className="border-b border-[#efe3d3] pb-3"><p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#9a735a]">Microphone</p><span className="mt-1 block text-sm font-semibold text-[#5c4c33]">H1 Zoom Handy Recorder</span></div>
                    <div><p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#9a735a]">Audio</p><span className="mt-1 block text-sm font-semibold text-[#5c4c33]">Binaural (Roland CS-10EM)</span></div>
                </div></div>
                <div className="rounded-[1.25rem] border border-[#eadfce] bg-[#fcfaf6] p-4"><div className="space-y-3">
                    ...
                    <div className="border-b border-[#efe3d3] pb-3"><p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#9a735a]">Frame Rate</p><span className="mt-1 block text-sm font-semibold text-[#5c4c33]">50 fps</span></div>
