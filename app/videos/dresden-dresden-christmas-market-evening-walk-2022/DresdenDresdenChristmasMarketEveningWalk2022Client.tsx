...
import { dresdenDresdenChristmasMarketEveningWalk2022Detail as detail } from "../../../data/video-details/dresden-dresden-christmas-market-evening-walk-2022";
...
const video = germanyVideos.find((v) => v.slug === "dresden-dresden-christmas-market-evening-walk-2022");
...
export default function DresdenDresdenChristmasMarketEveningWalk2022Client() {
