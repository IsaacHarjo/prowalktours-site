...
const parisLandmarksVideo = franceVideos.find(
  (video) => video.slug === "paris-landmarks-day-walk-2020"
);
const youtubeVideoId =
  parisLandmarksVideo?.youtubeUrl.split("/").pop() ?? "oz1Mgu8e1N4";
const heroImagePath = "/paris-landmarks-day-walk-2020/hero.jpg";
const fullMapUrl =
  "https://www.google.com/maps/d/viewer?mid=1OrG53UD3l4Ton0RpAUTcvXmpV-3-ily9";
const fullMapEmbedUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1OrG53UD3l4Ton0RpAUTcvXmpV-3-ily9";
...
const breadcrumbs = [
  ...
  { label: "Paris Day Walk (2020)" },
];

const highlights = parisLandmarksDayWalk2020Detail.highlights;
...
const relatedTours = [
  {
    ...
    description:
      "See the same landmarks after dark on a long-form evening route through central Paris.",
  ...
  },
  {
    ...
    description:
      "An evening walk focused on the Latin Quarter and Marais neighborhoods, Bastille nightlife, and a night bike ride.",
  ...
  },
  {
    ...
    description:
      "Go underground in Paris with a focused tour of the ossuary, bone corridors, and the historic catacombs entrance.",
    imageSrc: "/paris-catacombs-tour-2020/hero.jpg",
    imageAlt: "Paris Catacombs underground ossuary",
  },
];

export default function ParisLandmarksDayWalk2020Client() {
  const formattedFilmingDate = parisLandmarksVideo?.filmingDates[0]
    ? new Date(
        `${parisLandmarksVideo.filmingDates[0]}T12:00:00`
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udccf", label: "Distance", value: "12.0 mi / 19.3 km" },
    {
      icon: "\ud83d\udd52",
      label: "Duration",
      value: parisLandmarksVideo?.durationLabel ?? "5:38:18",
    },
    ...
    >
        ...
        <div className="mx-auto max-w-6xl px-6 py-12 lg:px-10 lg:py-16">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="min-w-0">
              <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#9a735a]">{parisLandmarksDayWalk2020Detail.heroEyebrow}</p>
              <h1 className="mt-3 text-4xl font-bold tracking-tight text-[#3d3327] sm:text-5xl">{parisLandmarksDayWalk2020Detail.heroTitle}</h1>
              <p className="mt-3 text-xl text-[#6e5a45]">{parisLandmarksDayWalk2020Detail.heroSubtitle}</p>
              <p className="mt-6 max-w-3xl text-base leading-8 text-[#56493a]">{parisLandmarksDayWalk2020Detail.heroDescription}</p>
            ...
            <div className="relative hidden overflow-hidden rounded-[2rem] border border-[#d8c7b5] bg-white shadow-sm lg:block">
              <div className="relative aspect-[4/3] w-full">
                <img src={heroImagePath} alt="Paris day walk landmarks" className="h-full w-full object-cover" loading="eager" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="route-map" ref={routeMapRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 py-8 lg:px-10 lg:py-10">
        <MapSection
          ...
          description={parisLandmarksDayWalk2020Detail.routeMapDescription}
          iframeSrc={fullMapEmbedUrl}
          iframeTitle="Paris day walk route map"
          ...
          <div className="mt-6 rounded-[1.75rem] border border-[#d8c7b5] bg-[#fcfaf6] p-5 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-[15px] leading-7 text-[#56493a]">Scan to open the Paris day walk route on your phone using Google Maps.</p>
              ...
              <a href={fullMapUrl} target="_blank" rel="noreferrer" className="self-start rounded-[1.5rem] border border-[#e5d7c6] bg-white p-3 shadow-sm transition hover:border-[#cdb7a0]" aria-label="Open the Paris day walk route map on your phone">
                <img src={fullMapQrUrl} alt="QR code for the Paris day walk route" width="132" height="132" className="h-[132px] w-[132px] rounded-xl" />
              </a>
            </div>
          </div>
        </MapSection>
        ...
        <div className="rounded-[2rem] border border-[#d8c7b5] bg-[#f7efe4] p-7 shadow-xl lg:p-8">
          <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">License this Paris day walk footage</h2>
              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">{parisLandmarksDayWalk2020Detail.licensingDescription[0]}</p>
              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">{parisLandmarksDayWalk2020Detail.licensingDescription[1]}</p>
            </div>
      ...
      <section id="related-tours" ref={relatedToursRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 pb-16 lg:px-10">
        ...
        <p className="mt-4 max-w-3xl text-base leading-8 text-[#56493a]">Continue with an evening route, the Latin Quarter and Marais after dark, or go underground in the Catacombs.</p>
