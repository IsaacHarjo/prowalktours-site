...
import { stuttgartChristmasMarketEveningWalk2022Detail as detail } from "../../../data/video-details/stuttgart-christmas-market-evening-walk-2022";
...
const video = germanyVideos.find((v) => v.slug === "stuttgart-christmas-market-evening-walk-2022");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "DssVino8XPo";
...
export default function StuttgartChristmasMarketEveningWalk2022Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udccf", label: "Distance", value: "1.28 mi / 2.10 km" },
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "1:04:32" },
    { icon: "\ud83c\udf19", label: "Weather", value: "-4°C | 24°F" },
  ];
