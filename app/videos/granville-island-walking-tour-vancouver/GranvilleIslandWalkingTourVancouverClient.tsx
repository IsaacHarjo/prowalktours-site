...
const youtubeVideoId = videoRecord?.youtubeUrl.split("/").pop() ?? "fyQqc6cZNA8";
const fullMapUrl =
  "https://www.google.com/maps/d/edit?mid=1AvMNUp7Mt-egkR8YKLURr19TRm_Mn5g&usp=sharing";
const fullMapEmbedUrl =
  "https://www.google.com/maps/d/embed?mid=1AvMNUp7Mt-egkR8YKLURr19TRm_Mn5g";
...
const breadcrumbs = [
  ...
  { label: "Granville Island Walking Tour" },
];

const detail = granvilleIslandWalkingTourVancouverDetail;
...
const relatedVideos: RelatedVideo[] = [
  {
    ...
    description: "An evening walk along Sunset Beach and English Bay at golden hour.",
  ...
  },
  {
    ...
    description: "A full-length walking tour through downtown Vancouver.",
...
export default function GranvilleIslandWalkingTourVancouverClient() {
  ...
  const topRowStats = [
    ...
    { icon: "📏", label: "Distance", value: "1.6 mi / 2.6 km" },
    ...
    >
      ...
      <section ref={videoSectionRef} className="mx-auto max-w-6xl px-6 pb-6 pt-6 lg:px-10 lg:pb-6 lg:pt-14">
        <div className="overflow-hidden rounded-[2rem] border border-[#d8c7b5] shadow-lg">
          <div className="aspect-video w-full bg-black">
            {mounted && (<iframe ref={playerIframeRef} className="h-full w-full" src={initialYoutubeEmbedUrl} title="Granville Island walking tour Vancouver" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />)}
          </div>
        </div>
      </section>
      ...
      <section id="route-map" ref={routeMapRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 py-8 lg:px-10 lg:py-10">
        <MapSection
          ...
          iframeTitle="Granville Island walking route map"
          ...
          <div className="mt-6 rounded-[1.75rem] border border-[#d8c7b5] bg-[#fcfaf6] p-5 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-[15px] leading-7 text-[#56493a]">Scan to open the Granville Island walking route on your phone using Google Maps.</p>
              ...
              <a href={fullMapUrl} target="_blank" rel="noreferrer" className="self-start rounded-[1.5rem] border border-[#e5d7c6] bg-white p-3 shadow-sm transition hover:border-[#cdb7a0]" aria-label="Open the Granville Island route map on your phone">
                <img src={fullMapQrUrl} alt="QR code for opening the Granville Island walking route in Google Maps" width="132" height="132" className="h-[132px] w-[132px] rounded-xl" />
              </a>
            </div>
          </div>
        </MapSection>
        ...
        <div className="rounded-[2rem] border border-[#d8c7b5] bg-[#f7efe4] p-7 shadow-xl lg:p-8">
          <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">License this Granville Island footage</h2>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="rounded-[1.25rem] border border-[#eadfce] bg-[#fcfaf6] p-4">
                  <div className="space-y-3">
                    ...
                    <div>
                      <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#9a735a]">Color / Filmed</p>
                      <span className="mt-1 block text-sm font-semibold text-[#5c4c33]">Rec.709 — July 2025</span>
                    </div>
                  </div>
                </div>
              </div>
