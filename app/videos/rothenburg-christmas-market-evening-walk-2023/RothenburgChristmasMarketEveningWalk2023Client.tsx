...
import { rothenburgChristmasMarketEveningWalk2023Detail as detail } from "../../../data/video-details/rothenburg-christmas-market-evening-walk-2023";
...
const video = germanyVideos.find((v) => v.slug === "rothenburg-christmas-market-evening-walk-2023");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "jur8EnASUp0";
const heroImagePath = "/rothenburg-christmas-market-evening-walk-2023/hero.jpg";

const breadcrumbs = [{"label":"Home","href":"/"},{"label":"Countries","href":"/countries"},{"label":"Germany","href":"/destinations/germany"},{"label":"Rothenburg ob der Tauber, Germany Christmas Market Evening Walk"}];
...
export default function RothenburgChristmasMarketEveningWalk2023Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "1:38:00" },
