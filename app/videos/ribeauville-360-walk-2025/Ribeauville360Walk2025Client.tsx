...
import { ribeauville360Walk2025Detail as detail } from "../../../data/video-details/ribeauville-360-walk-2025";
...
const video = franceVideos.find((v) => v.slug === "ribeauville-360-walk-2025");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "ccCz_dKYS5c";
const heroImagePath = "/ribeauville-360-walk-2025/hero.jpg";

const breadcrumbs = [{"label":"Home","href":"/"},{"label":"Countries","href":"/countries"},{"label":"France","href":"/destinations/france"},{"label":"RibeauvilléChristmas Market 360° Walk"}];
...
export default function Ribeauville360Walk2025Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "1:29:35" },
