...
import { freiburgFreiburgChristmasMarketEveningWalk2025Detail as detail } from "../../../data/video-details/freiburg-freiburg-christmas-market-evening-walk-2025";
...
const video = germanyVideos.find((v) => v.slug === "freiburg-freiburg-christmas-market-evening-walk-2025");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "4bQoSIwQHZM";
const heroImagePath = "/freiburg-freiburg-christmas-market-evening-walk-2025/hero.jpg";
...
export default function FreiburgFreiburgChristmasMarketEveningWalk2025Client() {
