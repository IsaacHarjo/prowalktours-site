...
import { nurembergChristmasMarketDayWalk2022Detail as detail } from "../../../data/video-details/nuremberg-christmas-market-day-walk-2022";
...
const video = germanyVideos.find((v) => v.slug === "nuremberg-christmas-market-day-walk-2022");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "l6aGKVxo2kw";
...
export default function NurembergChristmasMarketDayWalk2022Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "1:45:30" },
    { icon: "\u2600\ufe0f", label: "Weather", value: "-1°C | 30°F" },
  ];
