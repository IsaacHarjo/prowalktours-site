...
import { nurembergNurembergChristmasMarketDayWalk2022Detail as detail } from "../../../data/video-details/nuremberg-nuremberg-christmas-market-day-walk-2022";
...
const video = germanyVideos.find((v) => v.slug === "nuremberg-nuremberg-christmas-market-day-walk-2022");
...
export default function NurembergNurembergChristmasMarketDayWalk2022Client() {
