...
import { esslingenEsslingenChristmasMarketDayWalk2024Detail as detail } from "../../../data/video-details/esslingen-esslingen-christmas-market-day-walk-2024";
...
const video = germanyVideos.find((v) => v.slug === "esslingen-esslingen-christmas-market-day-walk-2024");
...
export default function EsslingenEsslingenChristmasMarketDayWalk2024Client() {
