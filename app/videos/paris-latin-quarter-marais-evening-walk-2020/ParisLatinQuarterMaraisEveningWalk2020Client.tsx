...
const parisLatinQuarterVideo = franceVideos.find(
  (video) => video.slug === "paris-latin-quarter-marais-evening-walk-2020"
);
const youtubeVideoId =
  parisLatinQuarterVideo?.youtubeUrl.split("/").pop() ?? "1_XzrxXnwMM";
const heroImagePath = "/paris-latin-quarter-marais-evening-walk-2020/hero.jpg";
const fullMapUrl =
  "https://www.google.com/maps/d/u/0/edit?mid=16wQePbC2KRprUMgUlxpOKlGhzIh_BXmo&usp=sharing";
const fullMapEmbedUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=16wQePbC2KRprUMgUlxpOKlGhzIh_BXmo";
...
const highlights = parisLatinQuarterMaraisEveningWalk2020Detail.highlights;
...
const relatedTours: RelatedTour[] = [
  {
    ...
    description:
      "A broader Paris evening route covering Notre-Dame, the Eiffel Tower, the Louvre, and a late-night bike ride through central Paris.",
    imageSrc: "/paris-evening-walk-2022/paris-evening-walk-placeholder-hero.svg",
    imageAlt: "Paris evening walk 2022 preview",
  },
  {
    ...
    imageAlt: "Paris Catacombs tour preview",
  },
  {
    title: "Avignon Walking Tour",
    href: "/videos/avignon-walking-tour-2025",
    description:
      "Head south to Provence for a long-form walk through Avignon\u2019s papal landmarks, medieval streets, and city ramparts.",
    imageSrc: "/avignon-walking-tour-2025/avignon-hero-image.png",
    imageAlt: "Avignon walking tour preview",
  },
];

export default function ParisLatinQuarterMaraisEveningWalk2020Client() {
  const formattedFilmingDate = parisLatinQuarterVideo?.filmingDates[0]
    ? new Date(
        `${parisLatinQuarterVideo.filmingDates[0]}T12:00:00`
  ...
  const topRowStats = [
    ...
    { icon: "📏", label: "Distance", value: "5.35 mi / 8.60 km" },
    {
      icon: "🕒",
      label: "Duration",
      value: parisLatinQuarterVideo?.durationLabel ?? "1:06:13",
    },
    {
      icon: "☀️",
      label: "Weather",
    ...
    >
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="min-w-0">
              <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#9a735a]">
                {parisLatinQuarterMaraisEveningWalk2020Detail.heroEyebrow}
              </p>
              <h1 className="mt-3 text-4xl font-bold tracking-tight text-[#3d3327] sm:text-5xl">
                {parisLatinQuarterMaraisEveningWalk2020Detail.heroTitle}
              </h1>
              <p className="mt-3 text-xl text-[#6e5a45]">
                {parisLatinQuarterMaraisEveningWalk2020Detail.heroSubtitle}
              </p>
              <p className="mt-6 max-w-3xl text-base leading-8 text-[#56493a]">
                {parisLatinQuarterMaraisEveningWalk2020Detail.heroDescription}
              </p>
      ...
      >
        <MapSection
          ...
          description={parisLatinQuarterMaraisEveningWalk2020Detail.routeMapDescription}
          iframeSrc={fullMapEmbedUrl}
          iframeTitle="Paris Latin Quarter & Marais evening walk route map"
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-[15px] leading-7 text-[#56493a]">
                  Scan to open the Paris evening walk route on your phone using
                  Google Maps.
                </p>
                <a
                  href={fullMapUrl}
              ...
              <a
                ...
                aria-label="Open the Paris evening walk route map on your phone"
              >
                <img
                  src={fullMapQrUrl}
                  alt="QR code for opening the Paris evening walk route in Google Maps"
                  width="132"
                  height="132"
        ...
        <div className="rounded-[2rem] border border-[#d8c7b5] bg-[#f7efe4] p-7 shadow-xl lg:p-8">
          <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">
                License this Paris evening walk footage
              </h2>

              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">
                {parisLatinQuarterMaraisEveningWalk2020Detail.licensingDescription[0]}
              </p>

              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">
                {parisLatinQuarterMaraisEveningWalk2020Detail.licensingDescription[1]}
              </p>
            </div>
      ...
      >
        ...
        <p className="mt-4 max-w-3xl text-base leading-8 text-[#56493a]">
          Continue with a broader Paris evening route, go underground with the
          Catacombs tour, or head south to Provence.
        </p>
