...
const video = franceVideos.find((v) => v.slug === "montmartre-day-walk-2020");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "yqOlY5uBBbo";
const heroImagePath = "/montmartre-day-walk-2020/hero.jpg";
const fullMapUrl = "https://www.google.com/maps/d/viewer?mid=1z58tn9DFJwHhq1ezfXRusmF2CsDIxpO_";
const fullMapEmbedUrl = "https://www.google.com/maps/d/u/0/embed?mid=1z58tn9DFJwHhq1ezfXRusmF2CsDIxpO_";
...
const breadcrumbs = [
  ...
  { label: "Montmartre Day Walk (2020)" },
];

const highlights = montmartreDayWalk2020Detail.highlights;

const relatedTours = [
  { title: "Montmartre Evening Walk (2022)", href: "/videos/montmartre-evening-walk-2022", description: "See Montmartre after dark with Sacr\u00e9-C\u0153ur, Place du Tertre, Place des Abbesses, and Rue Lepic at dusk.", imageSrc: "https://i.ytimg.com/vi/hLa9PRc9DFk/maxresdefault.jpg", imageAlt: "Montmartre evening walk" },
...
export default function MontmartreDayWalk2020Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udccf", label: "Distance", value: "3.5 mi / 5.6 km" },
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "1:53:27" },
  ...
  return (
    ...
    >
        ...
        <div className="mx-auto max-w-6xl px-6 py-12 lg:px-10 lg:py-16">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="min-w-0">
              <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#9a735a]">{montmartreDayWalk2020Detail.heroEyebrow}</p>
              <h1 className="mt-3 text-4xl font-bold tracking-tight text-[#3d3327] sm:text-5xl">{montmartreDayWalk2020Detail.heroTitle}</h1>
              <p className="mt-3 text-xl text-[#6e5a45]">{montmartreDayWalk2020Detail.heroSubtitle}</p>
              <p className="mt-6 max-w-3xl text-base leading-8 text-[#56493a]">{montmartreDayWalk2020Detail.heroDescription}</p>
              <div className="mt-8 space-y-4 border-y border-[#d8c7b5]/80 py-4 text-[#3d3327]"><LongFormWalkStatsRow stats={topRowStats} /></div>
            </div>
            <div className="relative hidden overflow-hidden rounded-[2rem] border border-[#d8c7b5] bg-white shadow-sm lg:block"><div className="relative aspect-[4/3] w-full"><img src={heroImagePath} alt="Montmartre day walk" className="h-full w-full object-cover" loading="eager" /></div></div>
          </div>
        </div>
      </section>
          ...
          <div className="mt-6 rounded-[1.75rem] border border-[#d8c7b5] bg-[#fcfaf6] p-5 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-[15px] leading-7 text-[#56493a]">Scan to open the Montmartre day walk route on your phone using Google Maps.</p>
        ...
        <div className="rounded-[2rem] border border-[#d8c7b5] bg-[#f7efe4] p-7 shadow-xl lg:p-8">
          <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">{montmartreDayWalk2020Detail.licensingDescription[0]}</p>
              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">{montmartreDayWalk2020Detail.licensingDescription[1]}</p>
            </div>
      ...
      <section id="related-tours" ref={relatedToursRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 pb-16 lg:px-10">
        ...
        <p className="mt-4 max-w-3xl text-base leading-8 text-[#56493a]">Return to Montmartre at dusk, or explore a broader Paris landmarks route or evening walk.</p>
