...
import { rothenburgChristmasMarketDayWalk2023Detail as detail } from "../../../data/video-details/rothenburg-christmas-market-day-walk-2023";
...
const video = germanyVideos.find((v) => v.slug === "rothenburg-christmas-market-day-walk-2023");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "EzZhJgqsdYU";
const heroImagePath = "/rothenburg-christmas-market-day-walk-2023/hero.jpg";

const breadcrumbs = [{"label":"Home","href":"/"},{"label":"Countries","href":"/countries"},{"label":"Germany","href":"/destinations/germany"},{"label":"Rothenburg ob der Tauber, Germany Christmas Market Day Walk"}];
...
export default function RothenburgChristmasMarketDayWalk2023Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udccf", label: "Distance", value: "3.00 mi / 4.80 km" },
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "1:38:11" },
    { icon: "\u2600\ufe0f", label: "Weather", value: "0.5°C | 33°F" },
  ];
          ...
          <div className="mt-6 rounded-[1.75rem] border border-[#d8c7b5] bg-[#fcfaf6] p-5 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <a href="https://www.google.com/maps/d/viewer?mid=1sHVVO7f81QxO2fziOYRDryg3sV-1mW4" target="_blank" rel="noreferrer" className="mt-4 inline-flex items-center justify-center rounded-full border border-[#167fd5] bg-white px-4 py-2 text-sm font-semibold text-[#167fd5] shadow-sm transition hover:bg-[#edf6fd]">Open the route in Google Maps</a>
              </div>
              <a href="https://www.google.com/maps/d/viewer?mid=1sHVVO7f81QxO2fziOYRDryg3sV-1mW4" target="_blank" rel="noreferrer" className="self-start rounded-[1.5rem] border border-[#e5d7c6] bg-white p-3 shadow-sm transition hover:border-[#cdb7a0]" aria-label="Open route on phone"><img src={`https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=${encodeURIComponent("https://www.google.com/maps/d/viewer?mid=1sHVVO7f81QxO2fziOYRDryg3sV-1mW4")}`} alt="QR code for route" width="132" height="132" className="h-[132px] w-[132px] rounded-xl" /></a>
            </div>
          </div>
        </MapSection>
      </section>
