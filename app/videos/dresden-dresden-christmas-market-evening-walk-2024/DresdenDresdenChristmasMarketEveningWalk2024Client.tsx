...
import { dresdenDresdenChristmasMarketEveningWalk2024Detail as detail } from "../../../data/video-details/dresden-dresden-christmas-market-evening-walk-2024";
...
const video = germanyVideos.find((v) => v.slug === "dresden-dresden-christmas-market-evening-walk-2024");
...
export default function DresdenDresdenChristmasMarketEveningWalk2024Client() {
