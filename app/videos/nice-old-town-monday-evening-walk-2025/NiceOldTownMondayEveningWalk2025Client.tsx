...
const niceVideo = franceVideos.find(
  (video) => video.slug === "nice-old-town-monday-evening-walk-2025"
);
const youtubeVideoId =
  niceVideo?.youtubeUrl.split("/").pop() ?? "br0MPT2SdTE";
const heroImagePath = "/nice-old-town-monday-evening-walk-2025/hero.jpg";
const fullMapUrl =
  "https://www.google.com/maps/d/viewer?mid=1oS9dh052hHDnS0aF4ZlWcpk7mDKxCl4";
const fullMapEmbedUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1oS9dh052hHDnS0aF4ZlWcpk7mDKxCl4";
...
const breadcrumbs = [
  ...
  { label: "Nice Evening Walk" },
];

const highlights = niceOldTownMondayEveningWalk2025Detail.highlights;

const relatedTours = [
  {
    title: "Menton Walking Tour (2025)",
    href: "/videos/menton-france-walking-tour-2025",
    description:
      "Continue along the Riviera to Menton for a daytime walk through the old town, seaside promenades, and colorful architecture near the Italian border.",
    imageSrc: "/menton-france-walking-tour-2025/menton-hero-image.jpg",
    imageAlt: "Menton old town and waterfront",
  },
  {
    title: "Antibes Walking Tour (2025)",
    href: "/videos/antibes-daytime-walk-2025",
    description:
      "Explore Antibes with Old Town lanes, the Picasso Museum area, market streets, the marina, and waterfront paths along the French Riviera.",
    imageSrc: "/antibes-daytime-walk-2025/antibes-hero-image.jpg",
    imageAlt: "Antibes old town and waterfront",
  },
  {
    title: "Avignon Walking Tour (2025)",
    href: "/videos/avignon-walking-tour-2025",
    description:
      "Head inland to Provence for a long-form walk through Avignon's papal landmarks, medieval streets, and city ramparts.",
    imageSrc: "/avignon-walking-tour-2025/avignon-hero-image.png",
    imageAlt: "Avignon historic center",
  },
];

export default function NiceOldTownMondayEveningWalk2025Client() {
  const formattedFilmingDate = niceVideo?.filmingDates[0]
    ? new Date(
        `${niceVideo.filmingDates[0]}T12:00:00`
  ...
  const topRowStats = [
    ...
    { icon: "📏", label: "Distance", value: "2.4 mi / 3.9 km" },
    {
      icon: "🕒",
      label: "Duration",
      value: niceVideo?.durationLabel ?? "1:30:55",
    },
  ...
  const scrollToLicensing = () =>
    licensingHubRef.current?.scrollIntoView({ behavior: "smooth", block: "start" });
  const scrollToRelatedTours = () =>
    relatedToursRef.current?.scrollIntoView({ behavior: "smooth", block: "start" });
    ...
    >
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="min-w-0">
              <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#9a735a]">
                {niceOldTownMondayEveningWalk2025Detail.heroEyebrow}
              </p>
              <h1 className="mt-3 text-4xl font-bold tracking-tight text-[#3d3327] sm:text-5xl">
                {niceOldTownMondayEveningWalk2025Detail.heroTitle}
              </h1>
              <p className="mt-3 text-xl text-[#6e5a45]">
                {niceOldTownMondayEveningWalk2025Detail.heroSubtitle}
              </p>
              <p className="mt-6 max-w-3xl text-base leading-8 text-[#56493a]">
                {niceOldTownMondayEveningWalk2025Detail.heroDescription}
              </p>
            ...
            <div className="relative hidden overflow-hidden rounded-[2rem] border border-[#d8c7b5] bg-white shadow-sm lg:block">
              <div className="relative aspect-[4/3] w-full">
                <img src={heroImagePath} alt="Nice evening walk hero image" className="h-full w-full object-cover" loading="eager" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="route-map" ref={routeMapRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 py-8 lg:px-10 lg:py-10">
        <MapSection
          ...
          description={niceOldTownMondayEveningWalk2025Detail.routeMapDescription}
          iframeSrc={fullMapEmbedUrl}
          iframeTitle="Nice evening walk route map"
          ...
          <div className="mt-6 rounded-[1.75rem] border border-[#d8c7b5] bg-[#fcfaf6] p-5 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-[15px] leading-7 text-[#56493a]">Scan to open the Nice evening walk route on your phone using Google Maps.</p>
              ...
              <a href={fullMapUrl} target="_blank" rel="noreferrer" className="self-start rounded-[1.5rem] border border-[#e5d7c6] bg-white p-3 shadow-sm transition hover:border-[#cdb7a0]" aria-label="Open the Nice evening walk route map on your phone">
                <img src={fullMapQrUrl} alt="QR code for the Nice evening walk route" width="132" height="132" className="h-[132px] w-[132px] rounded-xl" />
              </a>
            </div>
          </div>
        </MapSection>
        ...
        <div className="rounded-[2rem] border border-[#d8c7b5] bg-[#f7efe4] p-7 shadow-xl lg:p-8">
          <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">License this Nice evening walk footage</h2>
              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">{niceOldTownMondayEveningWalk2025Detail.licensingDescription[0]}</p>
              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">{niceOldTownMondayEveningWalk2025Detail.licensingDescription[1]}</p>
            </div>
      ...
      <section id="related-tours" ref={relatedToursRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 pb-16 lg:px-10">
        ...
        <p className="mt-4 max-w-3xl text-base leading-8 text-[#56493a]">Continue along the French Riviera to Menton or Antibes, or head inland to Provence.</p>
