...
const video = franceVideos.find((v) => v.slug === "paris-landmarks-day-walk-2017");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "ME2zyNBh3JM";
const heroImagePath = "/paris-landmarks-day-walk-2017/hero.jpg";
const fullMapUrl = "https://www.google.com/maps/d/viewer?mid=1jrf6k5dzILNJCjvUsGUHM-hAfMjTCD4";
const fullMapEmbedUrl = "https://www.google.com/maps/d/u/0/embed?mid=1jrf6k5dzILNJCjvUsGUHM-hAfMjTCD4";
...
const breadcrumbs = [
  ...
  { label: "Paris Landmarks Day Walk (2017)" },
];

const highlights = parisLandmarksDayWalk2017Detail.highlights;

const relatedTours = [
  { title: "Paris Day Walk (2020)", href: "/videos/paris-landmarks-day-walk-2020", description: "A 12-mile daytime route through the same landmarks three years later, plus the Panth\u00e9on, Luxembourg Gardens, and the Eiffel Tower interior.", imageSrc: "https://i.ytimg.com/vi/oz1Mgu8e1N4/maxresdefault.jpg", imageAlt: "Paris landmarks day walk 2020" },
  { title: "Paris Evening Walk (2022)", href: "/videos/paris-evening-walk-2022", description: "See many of the same landmarks after dark on a long-form evening route through central Paris.", imageSrc: "https://i.ytimg.com/vi/fKgP6JGAM_A/maxresdefault.jpg", imageAlt: "Paris evening walk" },
...
export default function ParisLandmarksDayWalk2017Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udccf", label: "Distance", value: "12.0 mi / 19.3 km" },
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "3:08:07" },
    { icon: "\u2600\ufe0f", label: "Weather", value: "23\u00b0C | 73\u00b0F" },
  ];
  ...
  return (
    ...
    >
        ...
        <div className="mx-auto max-w-6xl px-6 py-12 lg:px-10 lg:py-16">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="min-w-0">
              <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#9a735a]">{parisLandmarksDayWalk2017Detail.heroEyebrow}</p>
              <h1 className="mt-3 text-4xl font-bold tracking-tight text-[#3d3327] sm:text-5xl">{parisLandmarksDayWalk2017Detail.heroTitle}</h1>
              <p className="mt-3 text-xl text-[#6e5a45]">{parisLandmarksDayWalk2017Detail.heroSubtitle}</p>
              <p className="mt-6 max-w-3xl text-base leading-8 text-[#56493a]">{parisLandmarksDayWalk2017Detail.heroDescription}</p>
              <div className="mt-8 space-y-4 border-y border-[#d8c7b5]/80 py-4 text-[#3d3327]"><LongFormWalkStatsRow stats={topRowStats} /></div>
            </div>
            <div className="relative hidden overflow-hidden rounded-[2rem] border border-[#d8c7b5] bg-white shadow-sm lg:block"><div className="relative aspect-[4/3] w-full"><img src={heroImagePath} alt="Paris landmarks day walk 2017" className="h-full w-full object-cover" loading="eager" /></div></div>
          </div>
        </div>
      </section>
      ...
      <section ref={videoSectionRef as React.RefObject<HTMLElement>} className="mx-auto max-w-6xl px-6 pb-6 pt-6 lg:px-10 lg:pb-6 lg:pt-14">
        <div className="overflow-hidden rounded-[2rem] border border-[#d8c7b5] shadow-lg"><div className="aspect-video w-full bg-black">{mounted && (<iframe ref={playerIframeRef} className="h-full w-full" src={initialYoutubeEmbedUrl} title="Paris, France Landmarks Day Walk (2017)" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />)}</div></div>
      </section>
          ...
          <div className="mt-6 rounded-[1.75rem] border border-[#d8c7b5] bg-[#fcfaf6] p-5 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-[15px] leading-7 text-[#56493a]">Scan to open the Paris landmarks walk route on your phone using Google Maps.</p>
        ...
        <div className="rounded-[2rem] border border-[#d8c7b5] bg-[#f7efe4] p-7 shadow-xl lg:p-8">
          <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">License this Paris footage</h2>
              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">{parisLandmarksDayWalk2017Detail.licensingDescription[0]}</p>
              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">{parisLandmarksDayWalk2017Detail.licensingDescription[1]}</p>
            </div>
      ...
      <section id="related-tours" ref={relatedToursRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 pb-16 lg:px-10">
        ...
        <p className="mt-4 max-w-3xl text-base leading-8 text-[#56493a]">See the same landmarks three years later, explore Paris after dark, or head to Montmartre.</p>
