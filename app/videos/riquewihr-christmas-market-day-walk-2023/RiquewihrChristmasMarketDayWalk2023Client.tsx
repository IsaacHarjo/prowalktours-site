...
import { riquewihrChristmasMarketDayWalk2023Detail as detail } from "../../../data/video-details/riquewihr-christmas-market-day-walk-2023";
...
const video = franceVideos.find((v) => v.slug === "riquewihr-christmas-market-day-walk-2023");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "MjtMfBRp4y4";
const heroImagePath = "/riquewihr-christmas-market-day-walk-2023/hero.jpg";

const breadcrumbs = [{"label":"Home","href":"/"},{"label":"Countries","href":"/countries"},{"label":"France","href":"/destinations/france"},{"label":"RiquewihrChristmas Market Day Walk"}];
...
export default function RiquewihrChristmasMarketDayWalk2023Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "1:36:53" },
