...
const youtubeVideoId = videoRecord?.youtubeUrl.split("/").pop() ?? "KQaXN949DW8";
const fullMapUrl =
  "https://www.google.com/maps/d/u/0/edit?mid=1dzhNSBsPiwT-k5nhGBDDMy-yBLfEPE0&usp=sharing";
const fullMapEmbedUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1dzhNSBsPiwT-k5nhGBDDMy-yBLfEPE0";
...
const breadcrumbs = [
  ...
  { label: "Vancouver Sunset Beach Evening Walk" },
];

const detail = vancouverSunsetBeachEveningWalk2025Detail;
const highlights = detail.highlights;

const relatedVideos: RelatedVideo[] = [
  {
    title: "Granville Island Walking Tour",
    href: "/videos/granville-island-walking-tour-vancouver",
    description: "Explore Granville Island's public market, galleries, and waterfront.",
    thumbnail: "https://i.ytimg.com/vi/fyQqc6cZNA8/maxresdefault.jpg",
  },
  {
    title: "Vancouver Evening Walk — Gastown (2025)",
    href: "/videos/vancouver-evening-walk-gastown-2025",
    description: "Coal Harbour, Gastown, Chinatown and Granville Street at dusk.",
    thumbnail: "https://i.ytimg.com/vi/idp8quobV8o/maxresdefault.jpg",
  },
  {
    title: "Vancouver, Canada Walking Tour",
    href: "/videos/vancouver-canada-walking-tour",
    description: "A full-day walking tour through Vancouver's downtown and waterfront.",
    thumbnail: "https://i.ytimg.com/vi/faUNhaRLpMc/maxresdefault.jpg",
  },
];

export default function VancouverSunsetBeachEveningWalk2025Client() {
  const formattedFilmingDate = videoRecord?.filmingDates[0]
    ? new Date(`${videoRecord.filmingDates[0]}T12:00:00`).toLocaleDateString(
        "en-US",
  ...
  const topRowStats = [
    ...
    { icon: "📏", label: "Distance", value: "1.75 mi / 2.8 km" },
    { icon: "🕒", label: "Duration", value: videoRecord?.durationLabel ?? "0:54:32" },
    { icon: "☀️", label: "Weather", value: videoRecord?.weather ?? "55°F / 13°C" },
  ];
          ...
          <nav className="mx-auto grid max-w-6xl grid-cols-[1fr_auto] items-center px-6 py-2 sm:py-3 lg:px-10">
            <div className="justify-self-end sm:justify-self-start">
              <div className="flex min-w-max items-center gap-4 text-xs font-semibold text-white/90 sm:gap-6 sm:text-sm">
                ...
                {highlights.length > 0 && <button onClick={scrollToHighlights} className="hidden transition hover:text-white sm:inline-flex" type="button">Highlights</button>}
    ...
    >
      ...
      <section ref={videoSectionRef} className="mx-auto max-w-6xl px-6 pb-6 pt-6 lg:px-10 lg:pb-6 lg:pt-14">
        <div className="overflow-hidden rounded-[2rem] border border-[#d8c7b5] shadow-lg">
          <div className="aspect-video w-full bg-black">
            {mounted && (<iframe ref={playerIframeRef} className="h-full w-full" src={initialYoutubeEmbedUrl} title="Vancouver Sunset Beach evening walk" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />)}
          </div>
        </div>
      </section>
      ...
      <section id="route-map" ref={routeMapRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 py-8 lg:px-10 lg:py-10">
        <MapSection
          ...
          iframeTitle="Vancouver Sunset Beach walking route map"
          ...
          <div className="mt-6 rounded-[1.75rem] border border-[#d8c7b5] bg-[#fcfaf6] p-5 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-[15px] leading-7 text-[#56493a]">Scan to open the Vancouver Sunset Beach walking route on your phone using Google Maps.</p>
              ...
              <a href={fullMapUrl} target="_blank" rel="noreferrer" className="self-start rounded-[1.5rem] border border-[#e5d7c6] bg-white p-3 shadow-sm transition hover:border-[#cdb7a0]" aria-label="Open the Vancouver Sunset Beach route map on your phone">
                <img src={fullMapQrUrl} alt="QR code for opening the Vancouver Sunset Beach walking route in Google Maps" width="132" height="132" className="h-[132px] w-[132px] rounded-xl" />
              </a>
            </div>
          </div>
        </MapSection>
      ...
      <section id="licensing" ref={licensingHubRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 pb-14 lg:px-10">
        <div className="rounded-[2rem] border border-[#d8c7b5] bg-[#f7efe4] p-7 shadow-xl lg:p-8">
          <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">License this Vancouver footage</h2>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="rounded-[1.25rem] border border-[#eadfce] bg-[#fcfaf6] p-4">
                  <div className="space-y-3">
                    ...
                    <div>
                      <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#9a735a]">Filmed</p>
                      <span className="mt-1 block text-sm font-semibold text-[#5c4c33]">April 2025</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section id="related-tours" ref={relatedToursRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 pb-16 lg:px-10">
        <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#9a735a]">Related Vancouver Videos</p>
        <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">Explore more from Vancouver</h2>
        <p className="mt-4 max-w-3xl text-base leading-8 text-[#56493a]">Continue exploring Vancouver with more walking tours along the waterfront and downtown.</p>
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {relatedVideos.map((tour) => (
            <Link key={tour.href} href={tour.href} className="group rounded-[1.5rem] border border-[#d8c7b5] bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-[#167fd5] hover:shadow-lg">
              <div className="mb-4 overflow-hidden rounded-[1rem] border border-[#eadfce]">
                <img src={tour.thumbnail} alt={`${tour.title} video thumbnail`} className="aspect-video w-full object-cover" loading="lazy" onError={(event) => { const image = event.currentTarget; image.onerror = null; image.src = tour.thumbnail.replace("/maxresdefault.jpg", "/hqdefault.jpg"); }} />
              </div>
              ...
              <p className="mt-4 text-sm font-semibold text-[#167fd5]">Watch Tour →</p>
            </Link>
          ))}
        </div>
      </section>
        ...
        <div className="rounded-[2rem] border border-[#d8c7b5] bg-gradient-to-br from-[#f4e6bc] via-[#fcfaf6] to-[#e7f1f8] p-8 shadow-sm lg:p-10">
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base leading-8 text-[#56493a]">Get updates when new walks, night tours, 360 videos, and destination pages go live on ProWalk Tours.</p>
