...
const fullMapUrl =
  "https://www.google.com/maps/d/edit?mid=19X3zTqHGmypTqQe4pFLMrD4g3L_4iJw&usp=sharing";
const fullMapEmbedUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=19X3zTqHGmypTqQe4pFLMrD4g3L_4iJw";
...
export default function NaplesNightWalk2025Page() {
  ...
  const breadcrumbs = [
    ...
    { label: "Naples Night Walk (June 2025)" },
  ];
  ...
  const pageTitle = naplesNightWalk2025Detail.heroTitle;
  const pageSubtitle = naplesNightWalk2025Detail.heroSubtitle;
  const pageShortDescription = naplesNightWalk2025Detail.heroDescription;
  const topRowStats = [
    {
      icon: "📅",
      label: "Date",
      value: "Saturday, June 7, 2025",
    },
    { icon: "📏", label: "Distance", value: "3.75 mi / 6.0 km" },
    { icon: "🕒", label: "Duration", value: "2h 12m" },
    {
      icon: "☀️",
      label: "Weather",
    ...
    <div className="min-h-screen bg-[#fcfaf6] text-[#3d3327]">
        ...
        <div className="mx-auto max-w-6xl px-6 py-12 lg:px-10 lg:py-16">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="min-w-0">
              ...
              <p className="mt-3 text-xl text-[#6e5a45]">{pageSubtitle}</p>
        ...
        <div className="overflow-hidden rounded-[2rem] border border-[#d8c7b5] shadow-lg">
          <div className="aspect-video w-full bg-black">
            {mounted && (<iframe
              ...
              title="Naples Italy night walking tour"
      ...
      >
        ...
        >
          {highlights.map((highlight) => {
            const highlightImageSrc = highlight.imageSrc || highlightFallbackImage;
      ...
      >
        <MapSection
          ...
          description={naplesNightWalk2025Detail.routeMapDescription}
          iframeSrc={fullMapEmbedUrl}
          iframeTitle="Naples night walking route map"
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-[15px] leading-7 text-[#56493a]">
                  Scan to open the Naples night walk route on your phone using
                  Google Maps.
                </p>
                <a
                  href={fullMapUrl}
              ...
              >
                <img
                  src={fullMapQrUrl}
                  alt="QR code for opening the Naples night walking route in Google Maps"
                  width="132"
                  height="132"
          ...
          <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">
                {naplesNightWalk2025Detail.licensingDescription[0]}
              </p>

              <p className="mt-5 max-w-2xl text-base leading-8 text-[#56493a]">
                {naplesNightWalk2025Detail.licensingDescription[1]}
              </p>
            </div>
