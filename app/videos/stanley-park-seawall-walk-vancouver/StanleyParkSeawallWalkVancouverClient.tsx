...
const youtubeVideoId = videoRecord?.youtubeUrl.split("/").pop() ?? "uN7UkfKc-_w";
const fullMapUrl =
  "https://www.google.com/maps/d/u/0/edit?mid=1eEpHXp0hDVkXp1LQxgY9u0tr8vEQ4ww&usp=sharing";
const fullMapEmbedUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1eEpHXp0hDVkXp1LQxgY9u0tr8vEQ4ww";
...
const breadcrumbs = [
  ...
  { label: "Stanley Park Seawall Walk" },
];

const detail = stanleyParkSeawallWalkVancouverDetail;
...
const relatedVideos: RelatedVideo[] = [
  {
    ...
    description: "A full walking tour through downtown Vancouver.",
    thumbnail: "https://i.ytimg.com/vi/faUNhaRLpMc/maxresdefault.jpg",
  },
  {
    title: "Vancouver Sunset Beach Evening Walk (2025)",
    href: "/videos/vancouver-sunset-beach-evening-walk-2025",
    description: "An evening walk along Sunset Beach and the English Bay seawall.",
    thumbnail: "https://i.ytimg.com/vi/KQaXN949DW8/maxresdefault.jpg",
  },
  {
    title: "Granville Island Walking Tour — Vancouver",
    href: "/videos/granville-island-walking-tour-vancouver",
    description: "Explore the vibrant Granville Island public market and waterfront.",
    thumbnail: "https://i.ytimg.com/vi/fyQqc6cZNA8/maxresdefault.jpg",
  },
];

export default function StanleyParkSeawallWalkVancouverClient() {
  ...
  const topRowStats = [
    ...
    { icon: "📏", label: "Distance", value: "8.0 mi / 12.9 km" },
    ...
    >
      ...
      <section ref={videoSectionRef} className="mx-auto max-w-6xl px-6 pb-6 pt-6 lg:px-10 lg:pb-6 lg:pt-14">
        <div className="overflow-hidden rounded-[2rem] border border-[#d8c7b5] shadow-lg">
          <div className="aspect-video w-full bg-black">
            {mounted && (<iframe ref={playerIframeRef} className="h-full w-full" src={initialYoutubeEmbedUrl} title="Stanley Park Seawall walking tour" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />)}
          </div>
        </div>
      </section>
      ...
      <section id="route-map" ref={routeMapRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 py-8 lg:px-10 lg:py-10">
        <MapSection
          ...
          iframeTitle="Stanley Park Seawall route map"
          ...
          <div className="mt-6 rounded-[1.75rem] border border-[#d8c7b5] bg-[#fcfaf6] p-5 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-[15px] leading-7 text-[#56493a]">Scan to open the Stanley Park Seawall route on your phone using Google Maps.</p>
              ...
              <a href={fullMapUrl} target="_blank" rel="noreferrer" className="self-start rounded-[1.5rem] border border-[#e5d7c6] bg-white p-3 shadow-sm transition hover:border-[#cdb7a0]" aria-label="Open the Stanley Park Seawall route map on your phone">
                <img src={fullMapQrUrl} alt="QR code for opening the Stanley Park Seawall route in Google Maps" width="132" height="132" className="h-[132px] w-[132px] rounded-xl" />
              </a>
            </div>
          </div>
        </MapSection>
                ...
                <div className="rounded-[1.25rem] border border-[#eadfce] bg-[#fcfaf6] p-4">
                  <div className="space-y-3">
                    <div className="border-b border-[#efe3d3] pb-3">
                      ...
                      <span className="mt-1 block text-sm font-semibold text-[#5c4c33]">GoPro Hero 6</span>
                    </div>
                    <div className="border-b border-[#efe3d3] pb-3">
                ...
                <div className="rounded-[1.25rem] border border-[#eadfce] bg-[#fcfaf6] p-4">
                  <div className="space-y-3">
                    <div className="border-b border-[#efe3d3] pb-3">
                      ...
                      <span className="mt-1 block text-sm font-semibold text-[#5c4c33]">29.97 fps</span>
                    </div>
                    <div className="border-b border-[#efe3d3] pb-3">
                    ...
                    <div>
                      ...
                      <span className="mt-1 block text-sm font-semibold text-[#5c4c33]">July 2018</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section id="related-tours" ref={relatedToursRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 pb-16 lg:px-10">
        ...
        <p className="mt-4 max-w-3xl text-base leading-8 text-[#56493a]">Continue exploring Vancouver with more walking tours.</p>
