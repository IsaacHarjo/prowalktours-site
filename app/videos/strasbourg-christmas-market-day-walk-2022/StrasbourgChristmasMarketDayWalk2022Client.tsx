...
import { strasbourgChristmasMarketDayWalk2022Detail as detail } from "../../../data/video-details/strasbourg-christmas-market-day-walk-2022";
...
const video = franceVideos.find((v) => v.slug === "strasbourg-christmas-market-day-walk-2022");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "B-wi7hIrgf8";
...
export default function StrasbourgChristmasMarketDayWalk2022Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udccf", label: "Distance", value: "4.25 mi / 6.80 km" },
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "2:24:49" },
    { icon: "\u2600\ufe0f", label: "Weather", value: "-6°C | 21°F" },
  ];
