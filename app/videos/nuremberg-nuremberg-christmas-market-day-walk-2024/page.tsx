...
import NurembergNurembergChristmasMarketDayWalk2024Client from "./NurembergNurembergChristmasMarketDayWalk2024Client";

const siteUrl = "https://www.prowalktours.com";
const pageUrl = `${siteUrl}/videos/nuremberg-nuremberg-christmas-market-day-walk-2024`;
...
export default function Page() {
  ...
  return (
    <>
      <Script id="nuremberg-nuremberg-christmas-market-day-walk-2024-bc-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbStructuredData) }} />
      <Script id="nuremberg-nuremberg-christmas-market-day-walk-2024-video-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(videoStructuredData) }} />
      <NurembergNurembergChristmasMarketDayWalk2024Client />
    </>
  );
}
