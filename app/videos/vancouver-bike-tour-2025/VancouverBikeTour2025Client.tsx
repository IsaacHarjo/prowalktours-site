...
const youtubeVideoId = videoRecord?.youtubeUrl.split("/").pop() ?? "dfWwFF4h5Sk";
const fullMapUrl =
  "https://www.google.com/maps/d/u/0/edit?mid=1OrorUUt4uUxv6TM-AUf2iOinISEoKQY&usp=sharing";
const fullMapEmbedUrl =
  "https://www.google.com/maps/d/u/0/embed?mid=1OrorUUt4uUxv6TM-AUf2iOinISEoKQY";
...
const breadcrumbs = [
  ...
  { label: "Vancouver Bike Tour" },
];

const detail = vancouverBikeTour2025Detail;
...
const relatedVideos: RelatedVideo[] = [
  {
    ...
    description: "A full walking tour through downtown Vancouver, Stanley Park, and the seawall.",
...
export default function VancouverBikeTour2025Client() {
  ...
  const topRowStats = [
    ...
    { icon: "📏", label: "Distance", value: "45.0 mi / 72.4 km" },
    { icon: "🕒", label: "Duration", value: videoRecord?.durationLabel ?? "4:16:47" },
    ...
    >
      ...
      <section ref={videoSectionRef} className="mx-auto max-w-6xl px-6 pb-6 pt-6 lg:px-10 lg:pb-6 lg:pt-14">
        <div className="overflow-hidden rounded-[2rem] border border-[#d8c7b5] shadow-lg">
          <div className="aspect-video w-full bg-black">
            {mounted && (<iframe ref={playerIframeRef} className="h-full w-full" src={initialYoutubeEmbedUrl} title="Vancouver bike tour" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />)}
          </div>
        </div>
      </section>
      ...
      <section id="route-map" ref={routeMapRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 py-8 lg:px-10 lg:py-10">
        <MapSection
          ...
          iframeTitle="Vancouver bike tour route map"
          ...
          <div className="mt-6 rounded-[1.75rem] border border-[#d8c7b5] bg-[#fcfaf6] p-5 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-[15px] leading-7 text-[#56493a]">Scan to open the Vancouver bike tour route on your phone using Google Maps.</p>
              ...
              <a href={fullMapUrl} target="_blank" rel="noreferrer" className="self-start rounded-[1.5rem] border border-[#e5d7c6] bg-white p-3 shadow-sm transition hover:border-[#cdb7a0]" aria-label="Open the Vancouver bike tour route map on your phone">
                <img src={fullMapQrUrl} alt="QR code for opening the Vancouver bike tour route in Google Maps" width="132" height="132" className="h-[132px] w-[132px] rounded-xl" />
              </a>
            </div>
          </div>
        </MapSection>
        ...
        <div className="rounded-[2rem] border border-[#d8c7b5] bg-[#f7efe4] p-7 shadow-xl lg:p-8">
          <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">License this Vancouver bike tour footage</h2>
