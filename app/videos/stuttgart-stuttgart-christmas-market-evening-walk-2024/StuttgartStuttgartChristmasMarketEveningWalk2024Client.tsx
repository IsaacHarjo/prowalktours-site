...
import { stuttgartStuttgartChristmasMarketEveningWalk2024Detail as detail } from "../../../data/video-details/stuttgart-stuttgart-christmas-market-evening-walk-2024";
...
const video = germanyVideos.find((v) => v.slug === "stuttgart-stuttgart-christmas-market-evening-walk-2024");
...
export default function StuttgartStuttgartChristmasMarketEveningWalk2024Client() {
