...
import { nurembergChristmasMarketDayWalk2024Detail as detail } from "../../../data/video-details/nuremberg-christmas-market-day-walk-2024";
...
const video = germanyVideos.find((v) => v.slug === "nuremberg-christmas-market-day-walk-2024");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "9AD44Xk2Jkg";
const heroImagePath = "/nuremberg-christmas-market-day-walk-2024/hero.jpg";

const breadcrumbs = [{"label":"Home","href":"/"},{"label":"Countries","href":"/countries"},{"label":"Germany","href":"/destinations/germany"},{"label":"Nuremberg, Germany Christmas Market Day Walk"}];
...
export default function NurembergChristmasMarketDayWalk2024Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udccf", label: "Distance", value: "3.50 mi / 5.60 km" },
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "2:11:50" },
    { icon: "\u2600\ufe0f", label: "Weather", value: "2°C | 34°F" },
  ];
          ...
          <div className="mt-6 rounded-[1.75rem] border border-[#d8c7b5] bg-[#fcfaf6] p-5 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <a href="https://www.google.com/maps/d/viewer?mid=1_Fvtk_Zt_Tbh-gSxuoRYGJjV4Oxaj3Y" target="_blank" rel="noreferrer" className="mt-4 inline-flex items-center justify-center rounded-full border border-[#167fd5] bg-white px-4 py-2 text-sm font-semibold text-[#167fd5] shadow-sm transition hover:bg-[#edf6fd]">Open the route in Google Maps</a>
              </div>
              <a href="https://www.google.com/maps/d/viewer?mid=1_Fvtk_Zt_Tbh-gSxuoRYGJjV4Oxaj3Y" target="_blank" rel="noreferrer" className="self-start rounded-[1.5rem] border border-[#e5d7c6] bg-white p-3 shadow-sm transition hover:border-[#cdb7a0]" aria-label="Open route on phone"><img src={`https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=${encodeURIComponent("https://www.google.com/maps/d/viewer?mid=1_Fvtk_Zt_Tbh-gSxuoRYGJjV4Oxaj3Y")}`} alt="QR code for route" width="132" height="132" className="h-[132px] w-[132px] rounded-xl" /></a>
            </div>
          </div>
        </MapSection>
      </section>
        ...
        <div className="rounded-[2rem] border border-[#d8c7b5] bg-[#f7efe4] p-7 shadow-xl lg:p-8">
          <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">License this Nuremberg footage</h2>
