...
export default function AntibesDaytimeWalk2025Client() {
  const antibesVideo = franceVideos.find(v => v.slug === "antibes-daytime-walk-2025");
  ...
  const fullMapUrl = "https://www.google.com/maps/d/edit?mid=1rLDFZIOJ2kURpaQjtsitNb-0lpfOT2w&usp=sharing";
  const fullMapEmbedUrl = "https://www.google.com/maps/d/u/0/embed?mid=1rLDFZIOJ2kURpaQjtsitNb-0lpfOT2w";
  ...
  const formattedFilmingDate = antibesVideo?.filmingDates[0]
    ? new Date(`${antibesVideo.filmingDates[0]}T12:00:00`).toLocaleDateString("en-US", { weekday: "long", month: "long", day: "numeric", year: "numeric" })
    : "Friday, September 12, 2025";
  const topRowStats = [
    { icon: "📅", label: "Date", value: formattedFilmingDate },
    { icon: "📏", label: "Distance", value: "4.25 miles" },
    { icon: "🕒", label: "Duration", value: antibesVideo?.durationLabel ?? "2h 16m" },
    { icon: "☀️", label: "Weather", value: antibesVideo?.weather ?? "29 C / 85 F" },
  ];
  const breadcrumbs = [
    { label: "Home", href: "/" },
  ...
  const relatedTours = [
    { title: "Menton Walking Tour", href: "/videos/menton-france-walking-tour-2025", description: "Continue along the French Riviera with another long-form walk through Menton.", imageSrc: "https://i.ytimg.com/vi/ulReotWQvO0/maxresdefault.jpg", imageAlt: "Menton France walking tour thumbnail" },
    { title: "French Riviera Hub", href: "/destinations/france/french-riviera", description: "Browse the growing French Riviera collection, including Antibes and Menton.", imageSrc: heroImagePath, imageAlt: "Antibes French Riviera page preview" },
    { title: "France Destination Hub", href: "/destinations/france", description: "Explore France by region, from the French Riviera to Provence and beyond.", imageSrc: "https://i.ytimg.com/vi/naBkJ0bLzD0/maxresdefault.jpg", imageAlt: "France destination page preview" },
  ];
