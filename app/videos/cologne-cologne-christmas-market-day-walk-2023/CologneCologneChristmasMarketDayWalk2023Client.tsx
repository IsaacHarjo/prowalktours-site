...
import { cologneCologneChristmasMarketDayWalk2023Detail as detail } from "../../../data/video-details/cologne-cologne-christmas-market-day-walk-2023";
...
const video = germanyVideos.find((v) => v.slug === "cologne-cologne-christmas-market-day-walk-2023");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "GCsPZt5qUpg";
const heroImagePath = "/cologne-cologne-christmas-market-day-walk-2023/hero.jpg";
...
export default function CologneCologneChristmasMarketDayWalk2023Client() {
