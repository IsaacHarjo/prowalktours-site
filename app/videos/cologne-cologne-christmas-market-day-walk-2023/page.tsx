...
import CologneCologneChristmasMarketDayWalk2023Client from "./CologneCologneChristmasMarketDayWalk2023Client";

const siteUrl = "https://www.prowalktours.com";
const pageUrl = `${siteUrl}/videos/cologne-cologne-christmas-market-day-walk-2023`;
...
export default function Page() {
  ...
  return (
    <>
      <Script id="cologne-cologne-christmas-market-day-walk-2023-bc-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbStructuredData) }} />
      <Script id="cologne-cologne-christmas-market-day-walk-2023-video-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(videoStructuredData) }} />
      <CologneCologneChristmasMarketDayWalk2023Client />
    </>
  );
}
