...
import { otrantoDayWalk2026Detail as detail } from "../../../data/video-details/otranto-day-walk-2026";
...
const video = italyVideos.find((v) => v.slug === "otranto-day-walk-2026");
const youtubeVideoId = video?.youtubeUrl.split("/").pop() ?? "QMe441s-s4Q";
const heroImagePath = "/otranto-day-walk-2026/hero.jpg";

const breadcrumbs = [{"label":"Home","href":"/"},{"label":"Countries","href":"/countries"},{"label":"Italy","href":"/destinations/italy"},{"label":"Otranto Walking Tour 2026 - 4K - with Captions"}];
const highlights = detail.highlights;
const relatedTours = [
      { title: "Naples Day Walk (2023)", href: "/videos/naples-daytime-walk-2023", description: "A daytime route through the historic centre of Naples.", imageSrc: "https://i.ytimg.com/vi/990AqbKb18c/maxresdefault.jpg", imageAlt: "Naples day walk" },
      { title: "Naples Night Walk (2025)", href: "/videos/naples-night-walk-2025", description: "Naples after dark through the old town and waterfront.", imageSrc: "https://i.ytimg.com/vi/Cv1zIRhxvHU/maxresdefault.jpg", imageAlt: "Naples night walk" },
      { title: "Naples Bike Tour (2020)", href: "/videos/naples-bike-tour-2020", description: "A ride along the Naples seafront and through the city centre.", imageSrc: "https://i.ytimg.com/vi/IHXZnU2bmc8/maxresdefault.jpg", imageAlt: "Naples bike tour" }
];

export default function OtrantoDayWalk2026Client() {
  ...
  const topRowStats = [
    ...
    { icon: "\ud83d\udccf", label: "Distance", value: "3 mi / 5 km" },
    { icon: "\ud83d\udd52", label: "Duration", value: video?.durationLabel ?? "1:47:44" },
    { icon: "\u2600\ufe0f", label: "Weather", value: "31°C | 88°F" },
  ];
  ...
  return (
        ...
        <section className="sticky top-16 z-40 border-y border-[#7f5f49] bg-[#3d3327]/95 text-white backdrop-blur">
          <nav className="mx-auto grid max-w-6xl grid-cols-[1fr_auto] items-center px-6 py-2 sm:py-3 lg:px-10">
            ...
            <div className="hidden shrink-0 items-center gap-2 rounded-full border border-[#8f735c] bg-[#4a3c2f] px-3 py-1.5 text-sm font-semibold text-white/90 md:flex">
              <div className="h-4 w-6 overflow-hidden rounded-[2px] border border-white/20"><div className="grid h-full grid-cols-3"><div className="bg-green-600" /><div className="bg-white" /><div className="bg-red-600" /></div></div>
              <span>Italy</span>
            </div>
          </nav>
        </section>
    ...
    >
          ...
          <div className="mt-6 rounded-[1.75rem] border border-[#d8c7b5] bg-[#fcfaf6] p-5 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <a href="https://www.google.com/maps/d/viewer?mid=1yNJ7qu6CAcLeaQucWkdLL6DHuZQ83Ac" target="_blank" rel="noreferrer" className="mt-4 inline-flex items-center justify-center rounded-full border border-[#167fd5] bg-white px-4 py-2 text-sm font-semibold text-[#167fd5] shadow-sm transition hover:bg-[#edf6fd]">Open the route in Google Maps</a>
              </div>
              <a href="https://www.google.com/maps/d/viewer?mid=1yNJ7qu6CAcLeaQucWkdLL6DHuZQ83Ac" target="_blank" rel="noreferrer" className="self-start rounded-[1.5rem] border border-[#e5d7c6] bg-white p-3 shadow-sm transition hover:border-[#cdb7a0]" aria-label="Open route on phone"><img src={`https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=${encodeURIComponent("https://www.google.com/maps/d/viewer?mid=1yNJ7qu6CAcLeaQucWkdLL6DHuZQ83Ac")}`} alt="QR code for route" width="132" height="132" className="h-[132px] w-[132px] rounded-xl" /></a>
            </div>
          </div>
        </MapSection>
      </section>
        ...
        <div className="rounded-[2rem] border border-[#d8c7b5] bg-[#f7efe4] p-7 shadow-xl lg:p-8">
          <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">License this Otranto footage</h2>
            ...
            <div className="rounded-[1.75rem] border border-[#d8c7b5] bg-white p-5 shadow-sm sm:p-6">
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="rounded-[1.25rem] border border-[#eadfce] bg-[#fcfaf6] p-4"><div className="space-y-3">
                    ...
                    <div><p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#9a735a]">Color</p><span className="mt-1 block text-sm font-semibold text-[#5c4c33]">Rec. 2100 HLG</span></div>
                </div></div>
              </div>
      ...
      <section id="related-tours" ref={relatedToursRef} className="scroll-mt-32 mx-auto max-w-6xl px-6 pb-16 lg:px-10">
        ...
        <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#3d3327]">Explore more from Italy</h2>
        <p className="mt-4 max-w-3xl text-base leading-8 text-[#56493a]">Continue exploring with more walks and tours from Italy.</p>
        ...
        <div className="rounded-[2rem] border border-[#d8c7b5] bg-gradient-to-br from-[#f4e6bc] via-[#fcfaf6] to-[#e7f1f8] p-8 shadow-sm lg:p-10">
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base leading-8 text-[#56493a]">Get updates when new Italy tours, destination pages, and long-form videos go live on ProWalk Tours.</p>
